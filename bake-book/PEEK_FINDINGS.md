...
- **Lab-Rat** stamps: slope/angle materials · dirt/scatter/deform · PBR bake-down. Evan **clean** yelled 2026-09-08 ~00:00 ET — atelier plugs **open**. Atelier **150 roughness + textures/PBR ~26 sets landed**. #58/#60 stay the live yard plugs until more grit cooks
...
Range Tech Evan peek feel **landed #59**. Hypha ring-mip texture LOD **landed #60**. Hypha near LOD raise **landed #61**. Range Tech handmade atelier SFX vendor **landed #62**. Further Lab-Rat roughness→stamp still open (atelier PBR batch **in**; Evan **clean** yelled — plugs **open**). Do **not** claim the whole roughness→stamp cook.
...
- **Lab-Rat** — **#58 quiet grit greyscales landed** (vendored bake-downs + `sample_channels` quiet height + `grit::rough` wear — the near source for #60). Grit / slope / PBR plugs **open**. Further roughness → stamp stays on **fulcrumRust only**; bake-down first. SVG / density-mask / experiment-log still open. Slope/angle + scatter/deform sit on the big-map brief
