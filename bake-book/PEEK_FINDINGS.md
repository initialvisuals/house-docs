...
- Intact / out of scope: End PX ±0.50 (#159) · Options `look_mul` (#163) · Beabim leftover stash · PreferredHand · powder · Options hip Chest/Low · Hypha Graphics guts · Lab-Rat stamps · Augury Home. Two-instance shared `project.json` / flush race — **soft follow**; not in the #167 dial sheet. Do **not** invent a race fix
...
| **Range Tech** | **READY HIP** **landed #165**. Mouse V/H + hip/ADS **landed #163**; AIM TUNE PX-wall cook parallel; AIM TUNE LIVE per-kit pull **#167** parallel. Powder **B later landed #166** |
...
Invented default numbers parked. Powder **C** parked. Powder **B later landed #166**. PX clamp fix is Range cook, not this sheet’s implementation. Do **not** claim remaps / Tab press-toggle shipped. READY HIP **is** shipped #165. AIM TUNE LIVE **#167** is shipped. V·H·ADS **is** shipped #163. Graphics RES/FOV/AA/AO/POST **is** shipped #164.
...
- **Already shipped (siblings):** AIM TUNE LIVE persist **#103** + per-kit pull **#167** — not this spine's pose-bank cook
