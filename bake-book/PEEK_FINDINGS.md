...
- **U-cycle** — Chest (`hip`) → LowHip (`hip_low`) → Canted (`hip_cant`) → Chest. Glasses LowHip **LOW HIP** (was LOW). RMB from LowHip still irons
- **Unchanged** — ready hip / hip_cant / ADS / H crossover (#98 locks stay). #97 End AIM TUNE still live for fine nudge on these same dials
- Intact: #98 ready-hip / H · #94 first +0.08 · #97 End tuner · #59 travel DNA · #67 tip spawn · #84 tilt path · #89 projectiles. Greyzone canted CQC ADS **later landed #100**. Do **not** claim mesh mirror, Beabim, heat, or terrain as #99
...
- Intact: #99 hip_low · #98 ready-hip / H · #97 End tuner · #94 first +0.08 · #59 travel DNA · #67 tip spawn · #84 tilt path · #89 projectiles. Do **not** claim canted-holo mesh, IOR/bodycam glass, mesh flip, Beabim, heat, or terrain as #100
...
- **U** — unaimed-hold cycle Chest → LowHip → Canted. Glasses **LOW HIP** on #99 · **CANT 45** on Canted. **U** → CANT + RMB → `ads_cant` @ 60° CQC (**#100**). RMB from Chest/LowHip stays seated optic ads
