...
- **Windows builder stay-open + `build.log` tee** — Hypha polish on #42 one-click. Explorer double-click was closing with no readable success/fail. Does not wrap with `cmd /k`. Still does not touch atelier, HDRI, kits, or terrain
