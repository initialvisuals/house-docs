...
- Intact / out of scope: Hypha res / FOV slider / AA / AO / post / WARP / STREAM · Lab-Rat texture / mip · Augury remap / Tab · PreferredHand · AIM TUNE PX · stamps · death chrome. Options default hip **Chest (default)** vs **Low** toggle + Powder B — Range still cooking; do **not** claim landed. Do **not** invent implementation
...
## Holding / locked intent — Options shelf (res / graphics / FOV / remap / Tab; mouse sens landed #163)

Evan lock (2026-09-10 InitialVisuals). **Partial shipped #163** — Range Controls mouse V/H + hip/ADS. Rest **holding / locked intent**. Overnight cooks steal from `OPTIONS_SHELF.md` + fulcrumRust `docs/OPTIONS_MOUSE_SENS_DIAL_SHEET.md` — not chat. Do **not** invent numeric defaults unless already tip-locked elsewhere. No code.
...
- **Intent (still holding):** flesh out Options with resolution, graphics quality, FOV slider, remaps, Tab inventory press-toggle. Refer Concrete Echo for remap patterns
...
- **Camera / feel still holding:** FOV slider. Mouse V/H + hip/ADS **landed #163**
...
| **Clerk** | `OPTIONS_SHELF.md` + `OPTIONS_MOUSE_SENS.md` |

Invented default numbers parked. Powder A/B/C parked (Powder B still cooking — do **not** claim landed). PX clamp fix is Range cook, not this sheet’s implementation. Do **not** claim resolution / FOV slider / remaps / Tab press-toggle / hip toggle shipped. V·H·ADS split **is** shipped #163.
