...
**Host landed #81.** Peer feet stream anchors **landed #83**. Do **not** claim Lab-Rat stamp bake / NRM-GLOSS GPU / world replication / Range heat.
...
- **Beabim** MP: two-instance UDP **POSE** + HOLD JOIN panel **landed #83**. Grounded silhouettes share Hypha #88 `plant_simple_root` (packet / handshake / HOLD join stay #83). Shoot / HoB / heat / Locus / stamps / audio / ToD stay **local**
...
- **Range Tech**: kits + FX draw-distance on the wider yard; kit metal/grit PBR stub **landed #64**; store `dBXpg` still **open**; Music playlist beds **landed #64**; ADS viewmodel DoF **landed #68**; heat dial blend **landed #71**; land sway + heightfield FX **landed #79**; Options Audio DEVICE **landed #82**; H shoulder-swap tilt **landed #84**. HDRI sun disc **landed #87** (shared Hypha; dump **sunSize 0.62** rides the disc). Projectile feel **landed #89** (rect slab + debris + slug/wake + punch/scuff flash + fire-pulse glyphs — Vector mag dump live steal; artistic frame still `VECTOR_MAG_DUMP.md`). Heat cards / ballistics / binds **not touched** by #81. Heat / binds / ballistics / Audio DEVICE **not touched** by #86 / #87. #89 did **not** retune HeatDials / SIM / AXIS_LOCK +Z / #79 snap
...
- Intact: #79 land sway + heightfield FX · #16/#23/#43/#60/#61 prior facts. Do **not** claim Lab-Rat stamp bake / NRM-GLOSS GPU / world replication / Range heat. Peer feet `stream_anchors` **landed later #83** (coordinate only — no Transvoxel rewrite)
...
- Intact: #79 heightfield FX · #81 Transvoxel host · #83 packet / handshake / HOLD join. Mesher / LOD / stamps untouched. Do **not** claim Mixamo clip import / GPU skin / player body / 2-bone IK / mesher rewrite / Range shoot/feel/heat/binds / Lab-Rat stamp bake / Beabim net rewrite / HDRI sun
