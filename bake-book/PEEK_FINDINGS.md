...
**Host landed #81** (prior 8× 19×19). Live extents **#142** 37×37. Peer feet stream anchors **landed #83**. Lab-Rat slope/PBR/dirt/scatter/deform plugs **landed #80**. Stamp / building / terrain PBR polish **landed #144** (default `pbr=vendor`). Grit/COL LOD luma crawl stop **landed #152** (`STABLE_LOCUS_RES` **16** · `MATERIAL_HOLD_M` **2.5** · `LUMA_GRAIN` ±**0.08**). Do **not** claim NRM/GLOSS GPU / whole roughness→stamp / world replication / Range heat.
