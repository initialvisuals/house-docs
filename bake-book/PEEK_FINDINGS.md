...
- **Ownership** — Range Tech owns weapon/move SFX on the FX bus; Augury (Chamber) keeps spatial/reverb (#27); Lab-Rat stamps stay quiet. Evan lock: all authored audio comes over (clothing rustles, rattles, slides)
- **PARTIAL** — wiring + placeholders shipped; real CE / aim-offset packs + feel polish still next. Shot propagation still later. Do **not** claim feel polish or real packs as done
