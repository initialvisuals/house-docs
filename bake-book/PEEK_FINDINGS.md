...
- **Mute under Slain** — death envelope wins. Rim chrome mutes if Slain is live (no second leftover on the plate)
...
- Detail: house `FULCRUMRUST_LAST_PASS_LOCK.md` + fulcrumRust [`docs/SOFT_RIM_DIAL_SHEET.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/SOFT_RIM_DIAL_SHEET.md). CREDITS / STEAL_MAP / SOFT_RIM_DIAL_SHEET stay sources of truth
