...
- **Consume** — `GreyMap` / `HeightPack8` sample the sheet before wrap. Hypha `lod_mips` (256/64/16) + `pbr_shelf` COL consume the same `uv::xform`
- **Dial sheet:**
