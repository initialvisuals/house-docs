...
- Intact: #98 RH hip / H dials (was #94 when this PR shipped) · #67 tip spawn · #89 tracers. Do **not** claim Augury Home tabs/logger · EffectComposer · Beabim · Heat rewrite · Terrain · mesh mirror / `scale.x = −1` · PreferredHand onboard · ballistics / SIM / #76 · #89 tracers · Audio DEVICE · live-save persist (that is **#103**)
...
- **AIM TUNE live-save** — Range Tech. End AIM TUNE LIVE persist into Hypha `project.json` so Evan's peeks survive quit/relaunch. Steals Hypha Graphics/Audio persist path; does **not** take Augury Home. [PR #103](https://github.com/initialvisuals/fulcrumRust/pull/103) (`74da84e3` / `e0452f82`). Seat: **Range Tech**. Ledger: STEAL_MAP live-save row → **in** (house `X`). #97 End tuner / Delete JSON dump schema stay. Home stays unbound / Augury
...
- Intact: #97 End tuner · #98 ready-hip / H · #99 hip_low · #100 ads_cant · Delete JSON dump. Do **not** claim Augury Home tabs/logger · bake-permanent-defaults · UV (#101) · Beabim · heat rewrite · RECORD toggle bind
