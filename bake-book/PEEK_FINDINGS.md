...
- Intact / out of scope: Lab-Rat 7×7 stamp pad · Range / Beabim / Augury Home chrome · #131 biped · #136 landmark ride · #123 worker amortize path (deepened, not rewritten). Residual soft LOD pop / live octree still parked
- Detail: house `FULCRUMRUST_LAST_PASS_LOCK.md` + `TERRAIN_NORTHSTAR.md` + fulcrumRust `docs/TERRAIN.md`
