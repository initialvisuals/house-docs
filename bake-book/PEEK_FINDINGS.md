...
- Intact / out of scope: Range 1P feel / AIM TUNE / HoB / heat / zero / falloff · Lab-Rat stamps / pedon / CHANNELS · Hypha STREAM / mesher / 4× · Augury Home / hatch / death · Mixamo / hands / gear / server browser. Hideout hub leftover **later landed #153**. Do **not** claim Range / Hypha / Lab-Rat / Augury shipped this
- Detail: house `FULCRUMRUST_LAST_PASS_LOCK.md` + fulcrumRust [`docs/PVP_DIAL_SHEET.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/PVP_DIAL_SHEET.md). CREDITS / STEAL_MAP / PVP_DIAL_SHEET stay sources of truth. MP weapon honesty: Closed by #153
