...
- **Beabim / Hypha read** — `World.player_spawns: Vec<SpawnLocus>` (`pos`, `yaw`, `source` = Rim / Probe). Same World as yard `spawn` / `AuguryLocusSpawn` — do not invent a net KIND. Randomize + knock-off is Beabim (still open)
...
- Intact / out of scope: Beabim pool / knock-off / PVP / hitboxes / respawn UI · Hypha biped eye / cam · second MP KIND · Home chrome (#128 writer stays Augury) · CHANNELS dirt sit (#127) · pedon (#130) · pad crawl (#114). Do **not** claim Beabim knock-off / PVP / respawn UI / biped eye shipped by #132
...
- Intact / out of scope: Augury spatial/reverb (#27/#56) · punch-vs-scuff visuals (#89) · PVP/hitboxes · biped eye/cam · Lab-Rat stamps/pedon · Augury Home · CREDITS plant (separate PR). Do **not** claim Augury spatial rewrite, CREDITS, or a second mixer
