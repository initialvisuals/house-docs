...
**Locks 2026-09-07** — double-jump **unlocked** (Evan override of FPS-first "no double-jump"); texture LOD compress (Lab-Rat bake-down / Hypha ring mips); atelier still **read-only**. #25 lean / #57 medium dials stay shipped as-is. #51 Space hop is what `main` has until the Range Tech feel PR lands.
