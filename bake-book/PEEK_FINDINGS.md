...
- **`GateSignal`** — local leftover. Arm / frac for Beabim. No new KIND. Handshake / Esc-pause stay Beabim
- **Dial sheet:**
...
- Intact: #115 hatch HOLD/RIDE (`HOLD_SECS` **1.15** etc.) · #85 EXTRACT elbow · #78 hold-O intent · #51 F-only door (no walk-in auto-deploy). Do **not** claim timed surface kill / extract loot loop · Beabim pause/handshake · Hypha PreferredHand guts · bloom / god-rays · Range / Lab-Rat work as this PR
