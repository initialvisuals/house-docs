...
- **Per-kit ballistics** (`FeelSheet::fire`): MP9-Z AUTO ~1200 rpm / 300 m/s / kick 1.0 · SR-25 SEMI 0.14 s / 785 m/s / kick 1.15 · M24 bolt 0.65 s / 810 m/s / kick 1.75; HoB / muzzle / heat τ follow the feel-lab sheet. **Live tip #166:** SR-25 muzzle **810** (steal M24); gravity **9.8** / zero **100 m** held
...
- Detail: house `FULCRUMRUST_LAST_PASS_LOCK.md` + fulcrumRust STEAL_MAP Net row (todo→partial). PVP leftover: Closed by #133. HOST session board / no-127 invite: Closed by #139. PVP honesty: Closed by #141. Leftover ray: Closed by #147. MP weapon honesty: Closed by #153
...
- Parked / still TODO (do not claim done): death cam **later landed #146** + **#162**; teammate net stabilize; timed surface kill; full extract loot loop
...
- **Controls** — Look scale sits on feel-lab sens: `LOOK_MUL` default **1.0**, min **0.25**, max **2.0**, step **0.05**; Invert Y toggle. Binds stay README. Hint: `LOOK SITS ON FEEL-LAB SENS · BINDS IN README`. **Later landed #163** — split **MOUSE H/V · HIP · ADS** on that same lock (persist `look_mul_h` / `look_mul_v` / `hip_look_mul` / `ads_look_mul`). **Later landed #164** — Graphics **RES / FOV / AA / AA STR / AO / POST**. **Later landed #172** — Lab-Rat **TEXTURE / MIPMAP**
...
- **Seams Patch A** (dark-pad → hills): one extract density on every LOD (ChannelField vs HeightOnly disagreement fixed) · 8-subdiv bridge so 32→16→8→4 stays 2:1 Lengyel · yard flatten outer **9.2 → 20 m** so pad eases into hills. Residual soft LOD pop inside a cell still parked. Far-4 / void-past-extract horizon **later landed #151** cheap LOD-3 (`visible=5/19`) + desert floor. Stream hitch amortize **later landed #108** (cook=1/2 · prefetch=5 m). Play STREAM radius + warm hold **later landed #137**. STREAM past extract / desert / soft rim **later landed #151**
...
- Detail: house `FULCRUMRUST_LAST_PASS_LOCK.md` + fulcrumRust STEAL_MAP Net row. Loot trail: Closed by #102. World/sim leftover: Closed by #119. No-pause + KIND_RAID: Closed by #122. PVP leftover: Closed by #133. HOST session board / no-127 invite: Closed by #139. PVP honesty: Closed by #141. Leftover ray: Closed by #147. MP weapon honesty: Closed by #153
...
- Intact: #97 End tuner · #98 ready-hip / H · #99 hip_low · #100 ads_cant · Delete JSON dump. Do **not** claim Augury Home tabs/logger as #103 (that is **#110**) · bake-permanent-defaults · UV (#101) · Beabim · heat rewrite · RECORD toggle bind. Per-kit pull **later landed #167**
...
- Detail: house `FULCRUMRUST_LAST_PASS_LOCK.md` + fulcrumRust STEAL_MAP Net row. Loot trail: Closed by #102. World/sim leftover: Closed by #119. PVP leftover: Closed by #133. HOST session board / no-127 invite: Closed by #139. PVP honesty: Closed by #141. Leftover ray: Closed by #147. MP weapon honesty: Closed by #153
...
- Detail: house `FULCRUMRUST_LAST_PASS_LOCK.md` + fulcrumRust STEAL_MAP Net row. World/sim leftover: Closed by #119. PVP leftover: Closed by #133. HOST session board / no-127 invite: Closed by #139. PVP honesty: Closed by #141. Leftover ray: Closed by #147. MP weapon honesty: Closed by #153
...
- Detail: house `FULCRUMRUST_LAST_PASS_LOCK.md` + fulcrumRust STEAL_MAP Net row. No-pause + KIND_RAID: Closed by #122. PVP leftover: Closed by #133. HOST session board / no-127 invite: Closed by #139. PVP honesty: Closed by #141. Leftover ray: Closed by #147. MP weapon honesty: Closed by #153
...
- Detail: house `FULCRUMRUST_LAST_PASS_LOCK.md` + fulcrumRust `docs/GATE_DIAL_SHEET.md` KIND_RAID row / STEAL_MAP Net row. PVP leftover: Closed by #133. HOST session board / no-127 invite: Closed by #139. PVP honesty: Closed by #141. Leftover ray: Closed by #147. MP weapon honesty: Closed by #153
...
- **Post strength + radius (still #66):** `#129` shipped `visual * haze`. Haze **0.01** at the floor is **0.01** — shader early-out `< 0.01` then × **0.010** made hold-J invisible. **#155** restores `visual × lattice × 1.35` at the floor (× **1.20** at 0.11) + gate **0.001**. **0** still kills warp. Radius scale/cap **0.40 / 0.08**. Tip-weighted lattice energy + energy-weighted post UV (field on the can, not a haze cloud). Overlay disc lobe stays parked (`HEAT_LOBE_DISCS = 0`)
- Intent: hotter can tip, subtle muzzle warp, no fog blob. Tip-anchored lattice DNA stays. No second heat system. Glasses / live sheet still drive fields. #71 blend / aim-offset dump stay DNA on `heat-card-dial-sheet.md`. Visible hold-J warp **later landed #155**
- Intact: #66 colorless path · #59 lattice crawl as spatial input · #67 Patch A · #68 ADS near · #71 dump-blend DNA · **#89** projectile feel (untouched). Do **not** reopen orange cards. Warp visibility: Closed by #155
- Detail: house `heat-card-dial-sheet.md` + `HEAT_WARP_DIAL_SHEET.md` + `FULCRUMRUST_LAST_PASS_LOCK.md`
...
- Intact / out of scope: authored hip / H dest · #103 live-save · `hold_spring` · ADS blend · Beabim · Hypha stream · Lab-Rat stamps · Augury Home. Hideout LIVE wall **later landed #159**. Do **not** claim Beabim / Hypha / Lab-Rat / Augury shipped this
...
- Detail: house `FULCRUMRUST_LAST_PASS_LOCK.md` + fulcrumRust [`docs/PVP_DIAL_SHEET.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/PVP_DIAL_SHEET.md). CREDITS / STEAL_MAP / PVP_DIAL_SHEET stay sources of truth. PVP honesty: Closed by #141. Leftover ray: Closed by #147. MP weapon honesty: Closed by #153
...
- Intact / out of scope: Lab-Rat 7×7 stamp pad · Range / Beabim / Augury Home chrome · #131 biped · #136 landmark ride · #123 worker amortize path (deepened, not rewritten). Residual soft LOD pop / live octree still parked. 4× world + pend coalesce **later landed #142** (STREAM held 11×11). Live hold **later landed #151** (`hold=4/16` was 2/12) + cheap LOD-3 horizon / desert / soft rim — do **not** read #137 `hold=2/12` as the live tip
- Detail: house `FULCRUMRUST_LAST_PASS_LOCK.md` + `TERRAIN_NORTHSTAR.md` + fulcrumRust `docs/TERRAIN.md`
...
- Intact / out of scope: Range 1P feel / AIM TUNE / HoB / heat / SFX / eject dials · wound screen-react **later landed #143** (hooks Hit not Sync) · Lab-Rat stamps / pedon / CHANNELS · Hypha STREAM / mesher (#137 11×11 stay; live hold **later landed #151** 4/16 — consume height / PeerBody metres only) · Augury Home binds / hatch glasses · Death/Slain **later landed #146** + **#162** · party name exception · Range **2.5× head** · Mixamo / full 3P kit honesty / hands / gear · server browser / dedicated infra. Do **not** claim Range / Hypha / Lab-Rat / Augury shipped this
- Detail: house `FULCRUMRUST_LAST_PASS_LOCK.md` + fulcrumRust [`docs/PVP_DIAL_SHEET.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/PVP_DIAL_SHEET.md). CREDITS / STEAL_MAP / SPAWNS / PVP_DIAL_SHEET stay sources of truth. Wound feel: Closed by #143. Leftover ray: Closed by #147. Death / Slain: Closed by #146 + #162

## Closed by fulcrumRust #143 (2026-09-09)

- **1P screen-react — suppress / armour / HP feel** — Range Tech. 1P local only. Jostle + intensity envelopes on existing cam punch / land-sway / recoil-cam seats. Hypha post consumes `post.wound = [blur, red, 0, 0]`. Hooks Beabim `KIND_PVP` **Hit** (and local `apply_player_wound`) — **Sync** does not punch. Death/Slain **later landed #146** + **#162**. [PR #143](https://github.com/initialvisuals/fulcrumRust/pull/143) (`ae09f5f8`). Seat: **Range Tech**. CREDITS + WOUND_FEEL_DIAL_SHEET + STEAL already claimed in-PR — house shelf only. Do **not** invent dials. Do **not** invent A-note PRs
- **Dial sheet:**
...
- Intact / out of scope: Beabim net damage / #141 Sync / PeerBody · Hypha fullscreen order (SSAO → DoF → FXAA → CA → grain) · Lab-Rat stamps / pedon / 4× · AIM TUNE / HoB / heat lattice · Augury Home / hatch / Death/Slain chrome (**later landed #146** + **#162**). No Tarkov / Greyzone wording. Do **not** claim Beabim / Hypha / Lab-Rat / Augury shipped this
...
## Closed by fulcrumRust #159 (2026-09-10)

- **End PX clears leftover +0.226 from hideout live-save** — Range Tech. #138 named AIM TUNE PX **±0.50** but hideout LIVE still parked at **PX +0.2258** (Evan 2026-09-10, MP9-Z HIP). Fine/Coarse +X dead; −X free. Leftover +0.226 was never a write `min()` — `AimTuner::nudge` already clamped to `shoulder_x_max` **±0.50**; tests started at authored hip **+0.2403** (already past the wall). `hold_spring` **7.0** eased `hold_blend` so the gun lagged the panel. [PR #159](https://github.com/initialvisuals/fulcrumRust/pull/159) (merge `5478db35`). Seat: **Range Tech**. STEAL_MAP / CREDITS already claimed in-PR — house shelf only. Do **not** invent A-note PRs
- **Dial sheet — leftover wall ≠ End box:**

| Dial | Value | Notes |
|------|-------|-------|
| Authored MP9-Z hip X | **+0.2403** | Unchanged. Ready-hip RH |
| Hideout live-save (2026-09-10) | **+0.2258** | Under leftover wall. Fine +X leaves. Coarse → **+0.50** |
| Leftover derived +X wall | **+0.226** | `−shoulder_cross_x + shoulder_x_min`. Documented, **≠ End box** |
| `shoulder_x_max` / `TUNE_POS_X_ABS` | **±0.50** | Floor if dial is stale/zero. WEAPON + ATTACH PX |
| End PX min / max | **−0.50 / +0.50** | PY/PZ/rot unclamped |
| `hold_spring` | **7.0** | U-cycle ease stays. End WEAPON home-pose nudge **snaps** `hold_blend` |
| H dest / `shoulder_x_min` | **~−0.041** / **−0.055** | Unchanged. H live-pose left floor only |
| Live-save schema | #103 | `aim_tune` + `aim_live`. Untouched |
| ADS blend | **6.4** | Untouched |

- Intact / out of scope: authored hip / H dest · #103 live-save · ADS blend · Beabim · Hypha STREAM · Lab-Rat stamps · Augury Home · **PreferredHand live in AIM TUNE dialogue** (follow-up, not this cook). Do **not** claim Beabim / Hypha / Lab-Rat / Augury shipped this
- Detail: house `FULCRUMRUST_LAST_PASS_LOCK.md` + fulcrumRust [`docs/AIM_TUNE_X_DIAL_SHEET.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/AIM_TUNE_X_DIAL_SHEET.md). STEAL_MAP / CREDITS stay sources of truth

## Closed by fulcrumRust #157 (2026-09-10)

- **Desert skirt vendor sand COL — bare-height wash past extract** — Lab-Rat. Texture + UV / vertex paint only. Hypha #151 planted a flat desert skirt past extract (height + Sand hook). Yard sand tile **4.0 m** divides the old **8 m** quads, so every skirt vert sampled one COL texel — exterior read as bare height. [PR #157](https://github.com/initialvisuals/fulcrumRust/pull/157) (`f6cd2586`; merge tip `8431bc25`). Seat: **Lab-Rat**. Chunk metres **16** held. Extra grit still on building faces only. Hypha STREAM / RimHook / extract extents / remesh / landmark ride untouched. CREDITS + STAMP_PBR_DIAL_SHEET + TERRAIN / STAMPS already claimed in-PR — house shelf only. Do **not** invent dials. Do **not** invent A-note PRs
- **Closed (skirt COL):** steal existing vendor `pbr_sand_col` thumb (`pbr=vendor`). No new atlas. Walk past the 37×37 rim (~296 m) reads sand COL tiles, not a flat wash. Soft rim ~422 m is Hypha / Augury — untouched
- **Dial sheet:**
...
| Extent | `desert=8` / **128 m** | Held from #151 |
| Sample | `desert_skirt_color` → `pbr_shelf::albedo_desert` | Same sand map. `FULCRUM_UV` still remaps XZ. Grim clamp unchanged |
| Smoke | `pbr=vendor` `desert=8/col=2.8` | Title → Deploy → F → walk past extract |

- **#144 / #152 / #151 (held)** — `pbr=vendor` thumbs + grit-on-faces-only + locus/hold/grain + #151 height + Sand hook stay the prior layers
- Intact / out of scope: Hypha STREAM / RimHook / 37×37 / hitch / landmark ride / remesh · chunk resize · GPU NRM sampler on `fs_world` · Range powder / heat / AIM TUNE · Beabim KIND / PVP · Augury Home / glasses / radio / death. Do **not** claim Range / Hypha / Beabim / Augury shipped this
- Detail: house `FULCRUMRUST_LAST_PASS_LOCK.md` + fulcrumRust [`docs/STAMP_PBR_DIAL_SHEET.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/STAMP_PBR_DIAL_SHEET.md) + [`docs/TERRAIN.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/TERRAIN.md) + [`docs/STAMPS.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/STAMPS.md). CREDITS / STEAL_MAP / STAMP_PBR_DIAL_SHEET stay sources of truth

## Closed by fulcrumRust #154 (2026-09-10)

- **HOLO_MYCELIUM — cheap looping hideout hologram leftover** — Lab-Rat. First dial sheet + a cheap looping board-room hologram leftover for the pre-raid hideout hub. Low-res ever-generating / dying mycelium as a tight point cloud of blue leftover pixels (spheroid stand-ins), purple growth tips, brightness scales with size, blue scanline vibe. **Not** pycelium GPU mesocosm. [PR #154](https://github.com/initialvisuals/fulcrumRust/pull/154) (`d6b56a7e`). Seat: **Lab-Rat**. CREDITS + HOLO_MYCELIUM_DIAL_SHEET + STEAL already claimed in-PR — house shelf only. Do **not** invent dials. Do **not** invent A-note PRs. Do **not** invent a T·H·L hideout floorplan — Evan still owns the board-room
- **Closed (hideout leftover):** seated on the **existing hideout left desk**. Table AABB is a placeholder. Blue leftover pixels grow / die; tips read purple; a cyan scanline sweeps the cloud. No collide. No glasses
- **Dial sheet:**
...
| Pitch | **0.038** m | Cell spacing inside the hologram volume |
...
| Holo volume | table top + **0.02** m, centered XZ | Sits on the desk. No collide. No glasses |
| Env | `FULCRUM_HOLO=0` / `off` | Kill switch. Default on |

- **Peek** — Title → Deploy. Look **left** at the wood desk. Smoke `holo=gen=N cells=M tips=T`. Home **COLL**: table AABB wire (blue) + projected points. Extract `stream_rev` / terrain tris / CHANNELS layers must not move. Pedon rebake stays the extract leftover
- **#130 (held)** — extract sandbox pedon stays the extract leftover. Hideout upload reuses extract pedon leftover buffers (places never overlap)
- Intact / out of scope: Hypha STREAM / extract remesh / chunk metres / #151 sand COL · Beabim KIND / PeerBody / net · Range powder / Music · Augury Slain / arcade cabinets · pycelium-win GPU mesocosm · CHANNELS remesh · hideout furniture rewrite. Do **not** invent T·H·L. Do **not** claim Range / Hypha / Beabim / Augury shipped this
- Detail: house `FULCRUMRUST_LAST_PASS_LOCK.md` + fulcrumRust [`docs/HOLO_MYCELIUM_DIAL_SHEET.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/HOLO_MYCELIUM_DIAL_SHEET.md). CREDITS / STEAL_MAP / HOLO_MYCELIUM_DIAL_SHEET stay sources of truth

## Closed by fulcrumRust #171 (2026-09-10)

- **Locus Voidspore — cheap looping yard leftover** — Lab-Rat. Dial-honest first Locus Voidspore growth leftover — sit-on-surface colony on the extract yard, not a fourth plot and not a mesocosm. Dark / inked webbing + HOLO tip purple. [PR #171](https://github.com/initialvisuals/fulcrumRust/pull/171) (merge `ce4162a5`). Seat: **Lab-Rat**. CREDITS + VOIDSPORE_DIAL_SHEET + STEAL already claimed in-PR — house shelf only. Do **not** invent dials. Do **not** invent A-note PRs
- **Closed (yard leftover):** planted **left-forward of extract spawn** at XZ **−3.55, 2.35**. Dark inked webbing sits on the dirt; tips read purple; fruiting nodes stack like rock lobes. No collide. No glasses card. Home **COLL**: purple pad wire + projected points
- **Dial sheet:**
...
- **Peek** — Title → Deploy. Extract spawn faces +Z. Look **left** (~−X, a couple metres forward). Smoke `voidspore=gen=N cells=M tips=T`. Home **COLL**: purple pad wire + projected points. Extract `stream_rev` / terrain tris / CHANNELS layers must not move. Hideout HOLO stays the hideout leftover
- **#154 (held)** — hideout HOLO_MYCELIUM keeps the pedon slot. Quiet grit thumbs stay
- Intact / out of scope: Hypha STREAM / remesh / chunk 16 / RimHook / landmark ride · Range powder / AIM TUNE / PreferredHand · Beabim KIND / net · Augury Slain / glasses · pycelium-win GPU mesocosm · CHANNELS remesh · a fourth named plot. Do **not** claim Range / Hypha / Beabim / Augury shipped this
- Detail: house `VOIDSPORE.md` + `FULCRUMRUST_LAST_PASS_LOCK.md` + `STAMP_FEEL_LOCK.md` + fulcrumRust [`docs/VOIDSPORE_DIAL_SHEET.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/VOIDSPORE_DIAL_SHEET.md). CREDITS / STEAL_MAP / VOIDSPORE_DIAL_SHEET stay sources of truth
...
- Intact / out of scope: Range 1P feel / AIM TUNE / HoB / heat / zero / falloff · Lab-Rat stamps / pedon / CHANNELS · Hypha STREAM / mesher / 4× · Augury Home / hatch / death · Mixamo / hands / gear / server browser. Hideout hub leftover **later landed #153**. Ballistic leftover / `KIND_SHOT` loft **later landed #160**. Do **not** claim Range / Hypha / Lab-Rat / Augury shipped this
- Detail: house `FULCRUMRUST_LAST_PASS_LOCK.md` + fulcrumRust [`docs/PVP_DIAL_SHEET.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/PVP_DIAL_SHEET.md). CREDITS / STEAL_MAP / PVP_DIAL_SHEET stay sources of truth. MP weapon honesty: Closed by #153. Ballistics A leftover: Closed by #160


## Closed by fulcrumRust #146 + #162 (2026-09-10)

- **CE Slain death flow + glasses chrome** — Augury. PvE bleed-out envelope → Slain plate → PRESS SPACE after `SLAIN_INTERRUPT_SECS` **5.0**. Glasses + death overlay only. No HOST radio, no hitbox math, no Range live-world jostle. [PR #146](https://github.com/initialvisuals/fulcrumRust/pull/146) (`60a88648`). Follow-up overlay polish [PR #162](https://github.com/initialvisuals/fulcrumRust/pull/162) (`46fb2968`): hit leftover `HIT_GLITCH` **0.18** · downed `DOWN_BAR` full black · play HUD strip · `SLAIN_INTERRUPT_SECS` **5.0**. Seat: **The Augury**. CREDITS + DEATH_DIAL_SHEET + STEAL already claimed in-PR — house shelf only. Do **not** invent dials. Do **not** invent A-note PRs
- **Closed (death cam / Slain plate):** clock expiry plays Red → FadeBlack → Beat → Slain → Prompt. Space after `SLAIN_INTERRUPT_SECS` **5.0** → existing `claim_place_spawn` / hideout / rim (#141 pads). Space / continue illegal before 5.0 s, legal after. Full red→black→beat→slain.jpg→PRESS SPACE still plays
- **Dial sheet:**
...
| Prompt | `PROMPT_FADE_SECS` **0.60** | White mono **PRESS SPACE TO RESPAWN**. Space after `SLAIN_INTERRUPT_SECS` **5.0** |
| Hit flash | **0.18** s · wash **0.20** | — |
| Hit leftover | `HIT_GLITCH` **0.18** | Same band/chunk/chroma DNA as Slain. Decays with `HIT_FLASH_SECS`. Range #143 shake + red wash held |
| Downed wash | **0.48** | Stim still readable |
| Downed bars | `DOWN_BAR` **[0, 0, 0, 1]** | Full-width black HP/AR. Labels stay `DOWN` / `AR {kit.armor}` (#141 Sync) |
| Play HUD strip | on while downed or Slain live | Inventory / crosshair / heat / tuner / extras off. Overlay keeps wash + black bars + down-loop glasses (`DOWNED` / stim / stabilize) |
| Space gate | `SLAIN_INTERRUPT_SECS` **5.0** | Illegal before 5.0 s, legal after. Envelope still plays in full |
...
- **PVP** — down does **not** play Slain. Beabim 1.20s leftover auto-respawn unchanged. #153 hub protect / no-loot untouched
- Intact / out of scope: Range live hit-react (#143 jostle / world blur) · Beabim HOST / KIND_PVP / hitbox / #153 hub protect / no-loot · Lab-Rat stamps · Hypha 4× / landmark · soft-rim #156/#158 (no Slain plate). Do **not** claim Range / Hypha / Lab-Rat / Beabim shipped this
...
- **#80 / #101 / #112 (held)** — slope/PBR plugs + Blender UV sheet + Transvoxel UV consume stay the prior layers. Grit/COL LOD luma crawl stop **later landed #152**
...
## Closed by fulcrumRust #156 (2026-09-10)

- **Soft rim glasses leftover on Hypha RimHook** — Augury. Overlay + FX only. Ride Hypha #151 edge-triggered Home STREAM lines (`RIM APPROACH / BLOCK / CLEAR hook=augury`) for leftover chrome — **not** a Slain plate. [PR #156](https://github.com/initialvisuals/fulcrumRust/pull/156) (`f7167202`). Seat: **The Augury**. Soft-block physics stay Hypha (`apply_soft_rim` / `RIM_SOFT_M` **24** / world rim ~**422**). CREDITS + SOFT_RIM_DIAL_SHEET + STEAL already claimed in-PR — house shelf only. Do **not** invent dials. Do **not** invent A-note PRs. Do **not** claim Hypha / Range / Beabim / Lab-Rat shipped this
- **Thin hold follow-up #158** (2026-09-10, [`f42e5f9`](https://github.com/initialvisuals/fulcrumRust/pull/158)) — squash onto this shelf; **not** a second soft-rim landing. Hypha `apply_soft_rim` sets `RimHook.blocked` **only on the crossing frame**. After the spring stop, `hook.t` holds at **1.0** with `approaching` (`blocked=false`). Crossing-frame `blocked` alone is not enough — without a chrome hold, Augury flipped back to APPROACH / `SIGNAL  THINS`. Augury treats `hook.blocked || (hook.approaching && hook.t >= 0.995)` as **BLOCK** voice (`CARRIER  LOST` + glitch **0.36** + crackle). Overlay + FX only — does **not** rewrite Hypha physics / STREAM / sand COL / ballistics / AIM TUNE. Still mute under Slain; still no Slain plate / Space / death cam. Clerk classified **micro** under Evan major-only — CREDITS already covers soft-rim under #156; house shelf only. Do **not** re-credit the whole soft-rim system
- **Closed (hard rim slap / silent wall):** glasses whisper + death-DNA glitch leftover + FX radio crackle when the soft band is live. No Space respawn, death cam, or Slain climb
- **Dial sheet:**
...
- **Mute under Slain** — death envelope wins. Rim chrome mutes if Slain is live (no second leftover on the plate). #158 hold does not invent a Slain plate / Space / death cam
- Intact / out of scope: Hypha STREAM / desert skirt / soft-block math · Lab-Rat COL · Range heat/wound/AIM · Beabim net / KIND · PreferredHand · LANDMARK_RIDE · Slain plate / Space / death cam. Do **not** claim Hypha / Range / Beabim / Lab-Rat shipped this
- Detail: house `FULCRUMRUST_LAST_PASS_LOCK.md` + fulcrumRust [`docs/SOFT_RIM_DIAL_SHEET.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/SOFT_RIM_DIAL_SHEET.md). CREDITS / STEAL_MAP / SOFT_RIM_DIAL_SHEET stay sources of truth. #158 is chrome hold only — do **not** plant a second CREDITS / STEAL row

## Closed by fulcrumRust #162 (2026-09-10)

- **Death/down overlay chrome** — Augury. Follow-up polish on #146 Slain path — overlay chrome only. [PR #162](https://github.com/initialvisuals/fulcrumRust/pull/162) (`46fb2968`). Seat: **The Augury**. CREDITS + DEATH_DIAL_SHEET + STEAL already claimed in-PR — house shelf only. Do **not** invent dials. Do **not** invent A-note PRs
- **Closed (hit leftover / downed black bars / 5s Slain gate):** `HIT_GLITCH` **0.18** on punch (same band/chunk/chroma DNA as Slain; decays with `HIT_FLASH_SECS`). Downed HP/AR `DOWN_BAR` **[0, 0, 0, 1]** full-width black. Play HUD strip while downed or Slain live. `SLAIN_INTERRUPT_SECS` **5.0** — Space / continue illegal before 5.0 s, legal after. Full red→black→beat→slain.jpg→PRESS SPACE still plays
- **Dial sheet:**

| Dial | Value | Notes |
|------|-------|-------|
| `HIT_GLITCH` | **0.18** | Standing hit leftover. Same `glitch_quads` / band-shift DNA as Slain. Decays with `HIT_FLASH_SECS`. Range #143 shake + red wash stay |
| `DOWN_BAR` | **[0, 0, 0, 1]** | Downed HP/AR track + fill, full width. Labels stay `DOWN` / `AR {kit.armor}` (#141 Sync) |
| Play HUD strip | on while downed or Slain live | Inventory / crosshair / heat / tuner / extras off. Overlay keeps wash + black bars + down-loop glasses (`DOWNED` / stim / stabilize) |
| `SLAIN_INTERRUPT_SECS` | **5.0** | Space / continue gate. Envelope still plays in full. Illegal before 5.0 s |

- **#146 (held)** — Red `DEATH_RED_SECS` **0.55** wash 0.78 · FadeBlack **0.70** · Beat **1.00** · Slain `SLAIN_FADE_SECS` **0.78** · Prompt **0.60** · hit flash 0.18/0.20 · downed wash 0.48 · `BAR_CATCH` **6.5** · `GLITCH_PROMPT_FLOOR` **0.12**. PVP down does **not** play Slain
- Intact / out of scope: Range #143 wound camera · Beabim KIND / ray / #153 hub protect / no-loot / PVP 1.20s leftover · Lab-Rat stamps · Hypha STREAM · AIM TUNE PX · soft-rim #156/#158 (no Slain plate). Do **not** claim Range / Hypha / Lab-Rat / Beabim shipped this
- Detail: house `FULCRUMRUST_LAST_PASS_LOCK.md` + fulcrumRust [`docs/DEATH_DIAL_SHEET.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/DEATH_DIAL_SHEET.md). CREDITS / STEAL_MAP / DEATH_DIAL_SHEET stay sources of truth. Envelope: Closed by #146 + #162

## Closed by fulcrumRust #152 (2026-09-10)

- **Grit / COL dark-spot crawl on LOD promote** — Lab-Rat. Texture + UV / LOD sample stability only. Walking or zooming no longer recalculates grit/COL dark spots — they stay put at the same world XZ. [PR #152](https://github.com/initialvisuals/fulcrumRust/pull/152) (`a86c1ed6`). Seat: **Lab-Rat**. Chunk metres **16** held. Extra grit still on building faces only. Hypha STREAM / extract / hold / Transvoxel remesh / landmark ride / pend untouched. CREDITS + STAMP_PBR_DIAL_SHEET + CHANNELS / TERRAIN already claimed in-PR — house shelf only. Do **not** invent dials. Do **not** invent A-note PRs
- **Root:** grit/COL bilinear on promote reshuffled darks at the same world XZ (`sample_tiled` `fract(x/tile) * width` — a promote/demote changed the bilinear neighborhood). `material_lod` also flipped on the exact mesh chunk face
- **Dial sheet:**
...
| Height / DISP | bilinear (unchanged) |
| Chunk | **16** held. Off STREAM |

- **Peek** — `cargo run -- --smoke` (`pbr=vendor` `uv=1.00,1.00+0.00,0.00 r=0` `grit_mips=256/64/16`). `FULCRUM_UV=2,2` finer existing mips — not a remesh. Walk off the yard across a LOD ring (and zoom). Grit/COL dark spots should stay put. Geo pop-in is STREAM (separate)
- **#60 / #112 / #144 (held)** — grit mips + `promote_for_uv` + stamp PBR polish stay the prior layers
- Intact / out of scope: Hypha STREAM / 37×37 / hitch / landmark ride / remesh · chunk resize · GPU NRM sampler on `fs_world` · Range feel / AIM TUNE / wound · Beabim leftover ray / PVP · Augury Home / death. Do **not** claim Range / Hypha / Beabim / Augury shipped this
- Detail: house `FULCRUMRUST_LAST_PASS_LOCK.md` + fulcrumRust [`docs/STAMP_PBR_DIAL_SHEET.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/STAMP_PBR_DIAL_SHEET.md) (LOD luma crawl row) + [`docs/CHANNELS.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/CHANNELS.md) + [`docs/TERRAIN.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/TERRAIN.md). CREDITS / STEAL_MAP / STAMP_PBR_DIAL_SHEET stay sources of truth

## Closed by fulcrumRust #151 (2026-09-10)

- **Hypha STREAM past extract + desert floor + soft rim** — Hypha. Horizon / exterior / hold / rim-hook layer on the #142 37×37 host — **not** a fine STREAM radius bump. [PR #151](https://github.com/initialvisuals/fulcrumRust/pull/151) (merge `0f6171cf`). Seat: **Hypha**. Fine window stays #137 **11×11** (`STREAM_RINGS` 5 / r=5) — hitchy cook set held; do **not** claim the fine window grew. Hitch *fix* layers stay #108 / #123. Pend coalesce stays #142 `2/2`. Hitch *visibility* stays Augury #110 / #121 / #128. STEAL_MAP / CREDITS already claimed in-PR — house shelf only. Dial sheet: fulcrumRust `docs/TERRAIN.md`. Do **not** invent dials. Do **not** invent A-note PRs
- **Window (held)** — `STREAM_RINGS` **5** / **11×11**. Leading edge **80 m**. `wide` / `resident` grow this
...
- Intact / out of scope: Lab-Rat 7×7 / CHANNELS / pedon / grit crawl (#152) · Range feel / AIM TUNE / heat · Beabim net/PVP/HOST · Augury glasses chrome / Slain rewrite · rock desert / Lab-Rat COL. Residual soft LOD pop inside a cell / live octree still parked
- Detail: house `FULCRUMRUST_LAST_PASS_LOCK.md` + `TERRAIN_NORTHSTAR.md` + fulcrumRust `docs/TERRAIN.md`. CREDITS / STEAL_MAP stay sources of truth
...
## Closed by fulcrumRust #155 (2026-09-10)

- **Restore visible barrel heat warp at hold-J** — Range Tech. Overnight feel (Evan 2026-09-10): heat cards / barrel lattice warp missing — even at max Options **WARP** he could not see colorless tip distortion. [PR #155](https://github.com/initialvisuals/fulcrumRust/pull/155) (`d3d7848c`). Seat: **Range Tech** owns heat dials on the Hypha **#66** colorless post path. Cards still author the field. After #66 the cards do not draw RGB — warp *is* the look. `#129` `visual × 0.01` + shader early-out `< 0.01` then × **0.010** (~0.0001 UV) made the CE floor invisible. Options **WARP** is Hypha pixellation — not heat. CREDITS + HEAT_WARP_DIAL_SHEET + STEAL already claimed in-PR — house shelf only. Do **not** invent dials. Do **not** invent A-note PRs
- **Dial sheet:**
...
- **Ownership** — Cards author UV center / radius / lattice energy (RGB zeroed). `haze_strength` is the warp range. Options **WARP** stays Hypha floor pixellation. Fog stays the #86 dump
- Intact / out of scope: Lab-Rat stamps / UV · Hypha STREAM / bounds / Options **WARP** numbers · Beabim gun KIND · Augury chrome / Home · #89 projectile feel · AIM TUNE · #143 wound · ground haze stays **0**. Do **not** reopen orange cards. Do **not** claim Hypha / Lab-Rat / Beabim / Augury shipped this
- Detail: house `HEAT_WARP_DIAL_SHEET.md` + `heat-card-dial-sheet.md` + `FULCRUMRUST_LAST_PASS_LOCK.md` + fulcrumRust [`docs/HEAT_WARP_DIAL_SHEET.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/HEAT_WARP_DIAL_SHEET.md). CREDITS / STEAL_MAP / HEAT_WARP_DIAL_SHEET stay sources of truth

## Closed by fulcrumRust #153 (2026-09-10)

- **MP weapon honesty + hideout hub PeerBodies** — Beabim. Two-instance listen-server leftover after [#102](https://github.com/initialvisuals/fulcrumRust/pull/102) + [#91](https://github.com/initialvisuals/fulcrumRust/pull/91) + Evan hideout-hub fold. Dropped guns replicated on `KIND_LOOT` as a one-shot UDP event, then the remote rested immediately at throw-start; late join never received existing world drops. [PR #153](https://github.com/initialvisuals/fulcrumRust/pull/153) (merge `ecd9db82`). Seat: **Beabim**. Soft names from house `HIDEOUT_HUB.md`. CREDITS + MP_WEAPON_DIAL_SHEET + STEAL already claimed in-PR — house shelf only. Do **not** invent dials. Do **not** invent A-note PRs. Do **not** invent hall / wing / ceiling metres
- **Closed (world-drop honesty):** host `KIND_LOOT_WORLD` **15** snapshot (HELLO + ~4 Hz). Client upserts by instance id and drops foreign ghosts. Throw vel on `LootEvent` (bytes 44–55). Mag / reserves / optic / can from `KitLoadout::snapshot` — **no magic refill**
- **Closed (held 3P clone):** POSE unused **byte 3** advertises weapon / optic / can / empty hands. Remote `PeerBody` draws authored `kit_boxes` on `GUN_HOLD_LOCAL` `(0.18, 1.05, 0.28)` via `presented_local` so lean/peek rides the torso. House lock **1P≠3P** held
- **Closed (hideout hub leftover):** starting-room remotes draw. Hub downs keep kits (no `KIND_BODY` bag). `HUB_PROTECT_SECS` **15** (`protect_ms` on KIND_PVP bytes 22–23). Raid / extract stays normal (loot + 1.20 s leftover, no hub flag)
- **Dial sheet:**

| Dial | Value | Notes |
|------|-------|-------|
| `KIND_LOOT` | **8** | Drop / Take / Sync verb. Trail crumbs on Drop/Take only |
| `KIND_LOOT_WORLD` | **15** | Packed host leftover. `n` + up to **8** events (`WORLD_DROP_CAP`) |
| `LOOT_WORLD_SECS` | **0.25** | ~4 Hz. HELLO also dumps the current world |
| `RECV_BYTES` | **1024** | Was 256 — packed 8-drop snapshot is ~489 bytes |
| Throw vel | `LootEvent` bytes 44–55 | Both peers simulate the same toss. Old 48-byte leftovers decode vel **0** |
| Mag / attach | `KitLoadout::snapshot` | `in_mag` / `reserve_mags` / `mag_size` / optic / can. **No magic** |
...
| `HUB_PROTECT_SECS` | **15** | House `HIDEOUT_HUB`. Not `PVP_RESPAWN_SECS` **1.20**. KIND_PVP bytes 22–23 `protect_ms` |
| Hub no-loot | hideout starting room | Downs / hits do **not** drop kit or `KIND_BODY` bag. **Z** throw stays a player drop |

- **1P ≠ 3P (held)** — 3P is a readable authored clone on the posed hip-hand. Does **not** copy the viewmodel mesh / PreferredHand / End tuner sockets. Hands / gear / Mixamo still open
- **#141 / #147 (held)** — PeerBody leftover / HP/AR Sync / unique pads / leftover ray **500 m** unchanged. Raid leftover stays extract
- Intact / out of scope: Range 1P feel / AIM TUNE / HoB / heat / Music / powder · Hypha STREAM / Transvoxel / PeerBody box table · Lab-Rat stamps / volume metres · Augury death / Slain / crisp overlay / hatch / Home · hideout floorplan metres · Mixamo / hands / gear / server browser. Do **not** claim Range / Hypha / Lab-Rat / Augury shipped this
- Detail: house `FULCRUMRUST_LAST_PASS_LOCK.md` + `HIDEOUT_HUB.md` + fulcrumRust [`docs/MP_WEAPON_DIAL_SHEET.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/MP_WEAPON_DIAL_SHEET.md). CREDITS / STEAL_MAP stay sources of truth

## Closed by fulcrumRust #160 (2026-09-10)

- **KIND_SHOT loft + ballistic_A leftover (hitscan stash)** — Beabim leftover/net only. House `BALLISTICS_SPINE` cook **A**. Hitscan stashed, not deleted. [PR #160](https://github.com/initialvisuals/fulcrumRust/pull/160) (merge `e0803dc1967418fef7bdd7e04a31c2a3b2f681ed`). Seat: **Beabim**. CREDITS + STEAL_MAP + `BALLISTICS_A_DIAL_SHEET` already claimed in-PR — house shelf only. Do **not** invent dials. Do **not** invent A-note PRs. Range loft DNA + AIM TUNE stash **later landed #161**. Powder A/B/C still parked
- **Closed (`KIND_SHOT` loft):** `KIND_SHOT.dir` = HOST launch loft from `muzzle_and_launch` / `hip_honest` / MOA — **not** look-dir. Hip muzzle + speed/g unchanged. No KIND bump. Unused byte **3** stays
- **Closed (`ballistic_A` leftover):** HOST samples the arc with short straight substeps + shared `feel::step_ballistic` (same `vel.y -= g·dt` as the peer streak). Leftover stays eye **1.60**. Loft is the **same** `solve_ballistic_launch` from the leftover eye to the look-line at kit zero — do **not** reuse 1P muzzle HoB pitch (flies over the crown). Hit = where the sim body is. Max **500 m** / flat `SMG_PELLET` **14** held
- **Closed (hitscan stash):** `FULCRUM_LEFTOVER` / `project.json` `leftover_hit` / `Session::set_leftover_hit_model` restores the look-line eye ray. Range owns AIM TUNE / debugger chrome — leftover/net switch only
- **Dial sheet:**

| Dial | Value | Notes |
|------|-------|-------|
| Default model | **`ballistic_A`** | Arc samples + `feel::step_ballistic`. Same `vel.y -= g·dt` as peer streak |
| Stash restore | **`hitscan`** | Look-line eye ray. `FULCRUM_LEFTOVER` / `leftover_hit` / `Session::set_leftover_hit_model` |
| `KIND_SHOT.dir` | HOST launch loft | `muzzle_and_launch` / `hip_honest` / MOA. Not look-dir. No KIND bump. Unused byte **3** stays |
| Leftover origin | eye **1.60 m**, centered | #147 held. Re-solve loft from leftover eye via `solve_ballistic_launch` + kit zero |
| Max / pellet | **500 m** / `SMG_PELLET` **14** | Held. No invented falloff |
| Arc chord | `HEAD_HALF_H + HURT_SKIN` (**0.17 m**) | Not a parked powder dt / drag |
| Shared helpers | `feel::solve_ballistic_launch` · `feel::step_ballistic` · `biped::leftover_launch_dir` | Do not fork a second loft |

- **#147 (held)** — leftover max **500 m** · eye **1.60** · flat `SMG_PELLET` **14** · Locus yard **80 m** · PeerBody hurt skin/sweep
- Intact / out of scope: powder A/B/C **later landed Powder B #166** (A restoreable · C parked) · Hypha STREAM · Augury · hub protect · `KIND_LOOT_WORLD` · Locus yard **80 m**. Range loft DNA + AIM TUNE stash **later landed #161**. Do **not** claim Hypha / Lab-Rat / Augury shipped this
- Detail: house `BALLISTICS_SPINE.md` + `FULCRUMRUST_LAST_PASS_LOCK.md` + fulcrumRust [`docs/BALLISTICS_A_DIAL_SHEET.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/BALLISTICS_A_DIAL_SHEET.md). CREDITS / STEAL_MAP stay sources of truth. Range half: Closed by #161

## Closed by fulcrumRust #161 (2026-09-10)

- **Loft DNA + AIM TUNE leftover stash** — Range Tech. Consumes Beabim leftover/net (**#160**). House `BALLISTICS_SPINE` cook **A**. Tip order **#160 → #161** complete. [PR #161](https://github.com/initialvisuals/fulcrumRust/pull/161) (merge `4f47875376683f922c99adc7d7eb45a0736dc8a1`). Seat: **Range Tech**. CREDITS + STEAL_MAP + `BALLISTICS_A_DIAL_SHEET` Range section already claimed in-PR — house shelf only. Do **not** invent dials. Do **not** invent A-note PRs. Do **not** invent powder numbers. Do **not** claim Beabim leftover collide / Hypha / Lab-Rat / Augury shipped this
- **Closed (1P loft DNA):** `muzzle_and_launch` + `hip_honest_dir` + MOA is the body Beabim publishes as `KIND_SHOT.dir`. No `NetShot.loft`, no 48-byte KIND, no unused-byte model flag
- **Closed (tracer streak):** local/peer `TracerField` steals `feel::step_ballistic` (same `vel.y -= g·dt` leftover uses). Streak follows the lofted `ShotEvent`. Hitscan leftover stash does **not** flatten the streak
- **Closed (AIM TUNE MODEL):** End · INS cycle WEAPON → ATTACH → MODEL writes Beabim `leftover_hit` (`hitscan` / `ballistic_A`). Persist that key. TELE/PERF `LEFTOVER` line reads the same enum. No second `ballistic_model` persist key
- **Dial sheet:**

| Piece | Path | Notes |
|-------|------|-------|
| 1P loft DNA | `muzzle_and_launch` + `hip_honest_dir` + MOA | Same body as `KIND_SHOT.dir` |
| Tracer streak | `TracerField` + `feel::step_ballistic` | Local + peer follow lofted `ShotEvent` |
| AIM TUNE MODEL | End · INS WEAPON → ATTACH → MODEL | Writes `leftover_hit`. No `ballistic_model` |
| Debugger | TELE / PERF `LEFTOVER` | Same enum. Not a new Augury tab |

- **#160 (held)** — default `ballistic_A` · hitscan stash · eye **1.60** · **500 m** / `SMG_PELLET` **14** · arc chord **0.17 m** · KIND_SHOT 36 bytes
- Intact / out of scope: powder A/B/C **later landed Powder B #166** (A restoreable · C parked) · KIND_SHOT encode / leftover collide / HOST shared solve (Beabim) · Hypha STREAM / PeerBody mesh · Lab-Rat stamps · Augury chrome · #147 500 m / eye 1.60 / hub protect / `KIND_LOOT_WORLD` · no-pause / `fulcrum://`. Do **not** claim Beabim / Hypha / Lab-Rat / Augury shipped this Range half
- Detail: house `BALLISTICS_SPINE.md` + `FULCRUMRUST_LAST_PASS_LOCK.md` + fulcrumRust [`docs/BALLISTICS_A_DIAL_SHEET.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/BALLISTICS_A_DIAL_SHEET.md). CREDITS / STEAL_MAP stay sources of truth. Powder B: Closed by #166

## Closed by fulcrumRust #166 (2026-09-10)

- **Powder B slightly hot service** — Range Tech. Consumes leftover/net (**#160**) + loft DNA (**#161**). House `BALLISTICS_SPINE` leftover cook **A** held. Rifle powder tip is **B**. [PR #166](https://github.com/initialvisuals/fulcrumRust/pull/166) (merge `ca11b14349af448ec0ae782f97eccdbbbbc346c8`). Seat: **Range Tech**. CREDITS + STEAL_MAP + `BALLISTICS_A_DIAL_SHEET` Powder B table already claimed in-PR — house shelf only. Do **not** invent dials. Do **not** invent A-note PRs. Do **not** invent Powder C numbers. Do **not** claim Beabim leftover collide / Hypha / Lab-Rat / Augury shipped this
- **Closed (tip B):** honest milsim with a touch more energy than cold M118LR — not arcade. Numbers stolen from the existing kit pair (feel-lab SR-25 **785** / M24 **810**). Drop is the loft vacuum `0.5 · g · (range/speed)²` — same body as `solve_ballistic_launch`. No drag / Cd. Flat `SMG_PELLET` **14** held
- **Closed (SR-25):** muzzle **785 → 810** (steal M24). ½v² index 616225 → 656100 (**+6.47%**). Gravity **9.8** held. Zero **100 m** held (**−/=** 50/100/200 stay). Vacuum drop @ 420 m **1.403 → 1.317 m**. Vacuum drop @ 500 m **1.988 → 1.867 m**
- **Closed (held kits):** M24 already **810** / 9.8 / 100 (drop 1.317 / 1.867 at 420 / 500). MP9-Z **300** / **14.0** held (not rifle powder)
- **Closed (kinds):** `PowderKind` **B** tip default. **A** restoreable (`apply_rifle_powder`). **C** (friend-peek arcade) parked — `rifle_muzzle_speed() = None`, apply is a no-op. No persist key. Not `leftover_hit`
- **Dial sheet:**
...
| **C** | Friend-peek arcade | — | Parked. No kit numbers. `rifle_muzzle_speed() = None` |

| Kit / dial | Before (A / feel-lab) | After (**B** tip) |
|------------|----------------------|-------------------|
| SR-25 muzzle | **785 m/s** | **810 m/s** (steal M24) |
| SR-25 ½v² index | 616225 | 656100 (**+6.47%**) |
| SR-25 gravity / zero | **9.8** / **100 m** | held |
| SR-25 vacuum drop @ 420 / 500 m | **1.403** / **1.988 m** | **1.317** / **1.867 m** |
| M24 / MP9-Z | 810 / 300 | held |

- **#160 / #161 (held)** — default `ballistic_A` · hitscan stash · eye **1.60** · **500 m** / `SMG_PELLET` **14** · arc chord **0.17 m** · KIND_SHOT 36 bytes · AIM TUNE **MODEL** writes `leftover_hit`
- Intact / out of scope: Powder **C** numbers · KIND_SHOT encode / leftover collide / HOST shared solve (Beabim) · AIM TUNE leftover_hit · Hypha STREAM / PeerBody mesh / PreferredHand · Lab-Rat stamps · Augury chrome · #147 500 m / eye 1.60 / hub protect / `KIND_LOOT_WORLD` · no-pause / `fulcrum://`. Do **not** add READY HIP / Graphics / PreferredHand rows. Do **not** claim Beabim / Hypha / Lab-Rat / Augury shipped this Range powder
- Detail: house `BALLISTICS_SPINE.md` + `FULCRUMRUST_LAST_PASS_LOCK.md` + fulcrumRust [`docs/BALLISTICS_A_DIAL_SHEET.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/BALLISTICS_A_DIAL_SHEET.md). CREDITS / STEAL_MAP stay sources of truth

## Closed by fulcrumRust #163 (2026-09-10)

- **Options mouse V/H + hip/ADS** — Range Tech. House `OPTIONS_SHELF` Camera / feel seat. [PR #163](https://github.com/initialvisuals/fulcrumRust/pull/163) (merge `96e4410e`). Seat: **Range Tech**. CREDITS + STEAL_MAP + `OPTIONS_MOUSE_SENS_DIAL_SHEET` already claimed in-PR — house shelf only. Do **not** invent dials. Do **not** invent A-note PRs. Do **not** claim Hypha / Lab-Rat / Augury / Beabim shipped this
- **Closed (Controls rows):** **MOUSE H** (`look_mul_h`) · **MOUSE V** (`look_mul_v`) · **HIP** (`hip_look_mul`) · **ADS** (`ads_look_mul`) — all **1.00** on the existing #46 `LOOK_MUL` lock **0.25–2.00** / step **0.05**. Old single LOOK row is gone. Invert Y stays
- **Closed (persist):** `project.json` `look_mul_h` / `look_mul_v` / `hip_look_mul` / `ads_look_mul` on the existing Hypha save path. Old `"look_mul"` seeds both mouse axes when the split keys are absent. Split keys win when present. Hip / ADS default **1.00** on a partial load
- **Closed (live scale):** `yaw = look_dx × H × lerp(hip, ads, ads_factor) × feel_look_sens × fov_ads_scale` · same for pitch with V. Feel-lab `MoveDials.look_sens` **0.0022** + FOV-matched ADS weight stay DNA
- **Dial sheet:**

| Row | Persist | Default | Notes |
|-----|---------|---------|-------|
| **MOUSE H** | `look_mul_h` | **1.00** | Yaw. `LOOK_MUL` **0.25–2.00** / step **0.05** |
| **MOUSE V** | `look_mul_v` | **1.00** | Pitch. Same lock |
| **HIP** | `hip_look_mul` | **1.00** | Non-ADS look |
| **ADS** | `ads_look_mul` | **1.00** | **Not** feel `AdsHipDials.ads_look_mul` **0.86** |
| Feel ADS / blend | — | **0.86** / **6.4** | Held. Options ADS sits on top |
| Feel look_sens | — | **0.0022** | Held |

- Intact / out of scope: Hypha Graphics **later landed #164**. Lab-Rat texture / mip **later landed #172** · Augury remap / Tab · AIM TUNE PX · stamps · death chrome. READY HIP **later landed #165**. Powder **B later landed #166**. Do **not** invent implementation
- Detail: house `OPTIONS_SHELF.md` + `OPTIONS_MOUSE_SENS.md` + `FULCRUMRUST_LAST_PASS_LOCK.md` + fulcrumRust [`docs/OPTIONS_MOUSE_SENS_DIAL_SHEET.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/OPTIONS_MOUSE_SENS_DIAL_SHEET.md). CREDITS / STEAL_MAP stay sources of truth

## Closed by fulcrumRust #167 (2026-09-10)

- **AIM TUNE LIVE per-kit persist** — Range Tech. End LIVE follow-up so three-gun peeks survive relaunch. Flush no longer wipes other guns. [PR #167](https://github.com/initialvisuals/fulcrumRust/pull/167) (merge `aef44571`). Seat: **Range Tech**. CREDITS + STEAL_MAP + `AIM_TUNE_LIVE_SAVE` already claimed in-PR — house shelf only. Do **not** invent dials. Do **not** invent A-note PRs. Do **not** claim Hypha / Lab-Rat / Augury / Beabim shipped this
- **Closed (hole):** a new session seeds `FeelSheet` from authored kit defaults. `pull_aim` used to **replace** the whole persist blob from that sheet. One LIVE flush (End nudge, Options, debugger) before `apply_aim_settings` rewrote the other two kits back to authored. #103's live-reload test only covered one MP9 hip peek on a fresh sheet
- **Closed (pull / apply):** `pull_aim` is per-kit — an authored (untouched) kit on the live sheet keeps the persisted peek. `apply_aim_settings` snaps `hold_blend` so the seated gun matches the dial. Hideout restart: `seat_ready_hip()` then persist pull + apply
- **Dial sheet:**
...
- Intact / out of scope: End PX ±0.50 (#159) · Options `look_mul` (#163) · Beabim leftover stash · PreferredHand · powder · Options hip Chest/Low · Hypha Graphics guts · Lab-Rat stamps · Augury Home. Two-instance path + flush **later landed #169**
- Detail: house `AIM_TUNE_LIVE_SAVE.md` + `HOLD_POSE_SPINE.md` + `FULCRUMRUST_LAST_PASS_LOCK.md` + fulcrumRust [`docs/AIM_TUNE_LIVE_SAVE.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/AIM_TUNE_LIVE_SAVE.md). CREDITS / STEAL_MAP stay sources of truth

## Closed by fulcrumRust #169 (2026-09-10)

- **AIM TUNE two-exe persist** — Range Tech. HOST/peer peeks split when the second instance wrote another cwd `project.json`, or when a LIVE/Options flush last-wrote the whole `aim_tune` blob. [PR #169](https://github.com/initialvisuals/fulcrumRust/pull/169) (merge `ea342444`). Seat: **Range Tech**. Persist-only — did not retip powder / PreferredHand / Options. CREDITS + STEAL_MAP + `AIM_TUNE_LIVE_SAVE` already claimed in-PR — house shelf only. Do **not** invent dials. Do **not** invent A-note PRs. Do **not** claim Hypha / Lab-Rat / Augury / Beabim shipped this
- **Closed (path split):** Default persist is **cwd** `project.json`, now resolved **absolute**. `FULCRUM_SETTINGS` if set, else cwd. `build-and-run.bat` cds to the repo, so two bats share one file. Double-click `target\release\app.exe` (cwd = that folder) writes a **different** file. Same-machine HOST/peer that must share peeks: set **`FULCRUM_SETTINGS`** to one absolute path on both, or launch both from the same folder. Split files are intended if each exe wants its own Range dials
- **Closed (flush absorb):** AIM TUNE is local Range, not KIND_POSE. After apply, the peer sheet is last-loaded peeks (not authored), so `pull_aim` alone still last-wrote the whole `aim_tune` blob. LIVE / Options / debugger save now re-reads disk kits this instance has not End-nudged since load (`aim_epoch`). Same-kit last writer wins. `project.json.lock` serializes the read-merge-write. Instances do **not** hot-reload the other window — relaunch or a later undirty flush picks the file up
- **Dial sheet:**
...
- **Options Graphics RES / FOV / AA / AO / POST** — Hypha. House `OPTIONS_SHELF` Resolution / Graphics / FOV seat. [PR #164](https://github.com/initialvisuals/fulcrumRust/pull/164) (merge `159b3d11`). Seat: **Hypha**. CREDITS + STEAL_MAP + `OPTIONS_GRAPHICS_DIAL_SHEET` already claimed in-PR — house shelf only. Do **not** invent dials. Do **not** invent A-note PRs. Do **not** claim Range / Lab-Rat / Augury / Beabim shipped this
- **Closed (RES):** Default **NATIVE** (desktop native — no invented pair). Presets: 1280×720 · 1920×1080 · UW 2560×1080 · 2560×1440 · 3840×2160 4K · **UW 4K CLASS** (3840×1600 class) · **3440×1440** (Evan) · Steam survey fill **2560×1600 / 1920×1200 / 1366×768** (July 2026 primary display). Borderless stays desktop-native. Persist `resolution`
- **Closed (FOV):** Hip **base** default **90**. ADS still uses optic locks (iron/holo **60** · acog **25** · canted **60** CQC · scope **10**). Feel-sheet FOVs are not overwritten. Pane 70–110 / step 1 is Hypha chrome — **not** tip-locked. Persist `fov_hip`
- **Closed (AA / AA STR):** Type **FXAA / OFF**. Default FXAA. TAA later. **AA STR** **0–1** on the live #55 mix. Default **0.5** = pass knob. **Not** CA **0.35**. Persist `aa_type` / `aa_strength`
- **Closed (AO):** **OFF / LOW / HIGH**. Default Off. Low = live #55 8-tap · r **0.55**. High = Mycelium **24**-tap, same 0.55 radius. No invented radius. Persist `ao_quality`
- **Closed (POST):** **OFF / LOW / HIGH**. Default **HIGH**. Off skips Options post. Low = AA only. Heat #66 + wound #143 stay. Persist `post_quality`. Old `"ao"` / `"aa"` bools still load
- Intact / out of scope: Lab-Rat texture / mip **later landed #172** · Range #163 mouse V/H + hip/ADS · Augury remap / Tab · STREAM `StreamPolicy` · WINDOW / CA / GRAIN / DOF / FOG / CAM / WARP unchanged · Bloom / godRays no path. READY HIP **#165** already landed (sibling). Powder **B later landed #166**. AIM TUNE LIVE **#167** already landed (sibling)
- Detail: house `OPTIONS_SHELF.md` + `OPTIONS_GRAPHICS.md` + `FULCRUMRUST_LAST_PASS_LOCK.md` + fulcrumRust [`docs/OPTIONS_GRAPHICS_DIAL_SHEET.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/OPTIONS_GRAPHICS_DIAL_SHEET.md). CREDITS / STEAL_MAP stay sources of truth

## Closed by fulcrumRust #168 (2026-09-10)

- **PreferredHand A hold-bone mirror + HAND L/R chrome** — Range Tech. House `HOLD_POSE_SPINE`. [PR #168](https://github.com/initialvisuals/fulcrumRust/pull/168) (merge `1849ce6b`). Seat: **Range Tech**. CREDITS + STEAL_MAP + `PREFERRED_HAND_A_DIAL_SHEET` already claimed in-PR — house shelf only. Do **not** invent dials. Do **not** invent A-note PRs. Do **not** claim Hypha / Lab-Rat / Augury / Beabim shipped this
- **Closed (chrome):** **`HAND R` / `HAND L`** from **live hold X**. Gun right of camera middle (+X) = **HAND R**. Midline counts R. **Not** inverted `Shoulder` enum. Axis invert? **No**. Authored hip X **+0.2403**
- **Closed (mirror A):** One right bank. Left = sagittal **−X / −yaw / −roll** (cant **0.785** → **−0.785**). Pitch / Y / Z stay. **No** `scale.x = −1`. **H** is the live HAND flip. #116 onboard seats the home
- **Closed (AIM TUNE):** Shows **HAND · kit · pose** (`HAND R  MP9-Z  HIP`). Left numbers are the mirror. WEAPON +X while HAND L writes authored −X. End PX **±0.50** held. Live-save schema **landed #167** (sibling persist — not this chrome)
- **Closed (crosshair):** 2D HUD plus hides when `ads_factor` **> 0.5** (`FeelState::ADS_COMMIT`). Hip + U-cycle canted keep it. Options **CROSSHAIR** toggle stays. Augury death / downed strip untouched
- Intact / out of scope: Powder **B later landed #166** (A restoreable · C parked) · READY HIP persist **#165** already landed (sibling — do **not** restamp) · AIM TUNE LIVE **#167** already landed (sibling) · Options mouse V/H + hip/ADS · Hypha 3P lean · Lab-Rat stamps · Augury Home / death chrome. Leftover H dest ~**−0.041** is **not** the live left hold
- Detail: house `HOLD_POSE_SPINE.md` + `PREFERRED_HAND_A.md` + `FULCRUMRUST_LAST_PASS_LOCK.md` + fulcrumRust [`docs/PREFERRED_HAND_A_DIAL_SHEET.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/PREFERRED_HAND_A_DIAL_SHEET.md). CREDITS / STEAL_MAP stay sources of truth

## Closed by fulcrumRust #165 (2026-09-10)

- **Options READY HIP + two-pose play** — Range Tech. Steal house `OPTIONS_SHELF` + fulcrumRust [`docs/OPTIONS_DEFAULT_HIP_DIAL_SHEET.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/OPTIONS_DEFAULT_HIP_DIAL_SHEET.md). [PR #165](https://github.com/initialvisuals/fulcrumRust/pull/165) (merge `9b8121b1`). Seat: **Range Tech**. CREDITS + STEAL_MAP already claimed in-PR — house shelf only. Do **not** invent dials. Do **not** invent A-note PRs. Do **not** restamp planted **#163** mouse / hip / ADS rows
- **Closed (READY HIP):** Gameplay pane **CHEST** (tip default) / **LOW HIP**. Persist `default_hip` `"chest"` / `"low"`. Aliases `chest` / `ready` / `hip` · `low` / `low_hip` / `hip_low`. Missing key = Chest. Authored `hip` Y **−0.2128** · `hip_low` Y **−0.3528**
- **Closed (two-pose U):** in-play **U** is chosen default hip ↔ **canted** only. No Chest → LowHip → Canted ladder. Spawn / hideout ready / extract deploy / death+PVP respawn / quit-to-menu seat the pick. Canted is **not** a spawn pose
- **Closed (binds):** Hold-**Mouse5** still forces `ads_cant` from the default hip without stealing U. RMB from canted is CQC ADS. RMB from Low stays iron/optic — **#99**. `Settings::ready_hold(kind)` is `default_hip.resolve(kind)`
- **Parked (do not claim shipped):** Shotgun Low-later (`WeaponKind::default_hip_override` hook; day-one MP9-Z / SR-25 / M24 return `None`). PreferredHand HAND L/R Options chrome. Powder **B later landed #166**. AIM TUNE LIVE **#167** already landed (sibling — do not restamp **#103**)
- **Dial sheet:**

| Piece | Path | Notes |
|-------|------|-------|
| Options READY HIP | Gameplay **CHEST** / **LOW HIP** | Enter / click / A/D. Hypha persist same as glasses / crosshair |
| Chest | `default_hip`: `"chest"` | Tip default. `hip` Y **−0.2128** |
| Low hip | `default_hip`: `"low"` | Options other. `hip_low` Y **−0.3528** |
| In-play U | two poses | Chosen hip ↔ canted |
| Shotgun Low-later | `default_hip_override` | Hook only. **Not shipped** |

- Intact / out of scope: mouse V/H · hip/ADS look mul (**#163** planted) · Hypha res / FOV / AA / AO / post / WARP / STREAM · Lab-Rat texture / mip **later landed #172** · Augury remap / Tab · Powder **C** · PreferredHand mirror bank · stamps · Death chrome · AIM TUNE PX · authored pose numbers. Do **not** claim Beabim / Hypha / Lab-Rat / Augury shipped this. Powder **B later landed #166**
- Detail: house `OPTIONS_SHELF.md` + `HOLD_POSE_SPINE.md` + `FULCRUMRUST_LAST_PASS_LOCK.md` + fulcrumRust [`docs/OPTIONS_DEFAULT_HIP_DIAL_SHEET.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/OPTIONS_DEFAULT_HIP_DIAL_SHEET.md). CREDITS / STEAL_MAP stay sources of truth

## Closed by fulcrumRust #172 (2026-09-10)

- **Options TEXTURE + MIPMAP quality** — Lab-Rat. House `OPTIONS_SHELF` Graphics seat (#114). [PR #172](https://github.com/initialvisuals/fulcrumRust/pull/172) (merge `3ca49f27`). Seat: **Lab-Rat**. CREDITS + STEAL_MAP + `OPTIONS_TEXTURE_DIAL_SHEET` already claimed in-PR — house shelf only. Do **not** invent dials. Do **not** invent A-note PRs. Do **not** claim Hypha / Range / Augury / Beabim shipped this
- **Closed (TEXTURE):** Vendor COL / PBR shelf downsample of the existing thumb. Default **HIGH**. LOW 16² · MED 64² · HIGH 256² · ULTRA 256². Ultra === High — tip already ships 256² (`pbr=vendor`). Persist `texture_quality`. Not atelier 3K. Not a 4k atlas
- **Closed (MIPMAP):** How aggressive mid/far `lod_mips` packs get. Default **MED**. LOW +1 ring · MED identity · HIGH −1 · ULTRA −2. Bias sits **after** `promote_for_uv` / `MATERIAL_HOLD_M`. High ≈ `FULCRUM_UV` scale 2; Ultra ≈ scale 4 (lod-2 bridge → near 256²; lod-3 horizon → mid 64²). Persist `mipmap_quality`. Height / mesh lod / chunk metres **16** stay
- **Closed (apply):** Building solids sample COL live (`grade_solid`). Terrain verts + desert skirt **regrade** on change (recolor in place — no remesh, no STREAM radius). `FULCRUM_TEXTURE` / `FULCRUM_MIPMAP` override Options at boot
- **#152 (held):** `STABLE_LOCUS_RES` **16** · `MATERIAL_HOLD_M` **2.5** · `LUMA_GRAIN` ±**0.08**. Height / DISP stay bilinear
- **Dial sheet:**

| Dial | Persist | Default | Steps |
|------|---------|---------|-------|
| **TEXTURE** | `texture_quality` | **HIGH** | LOW 16² · MED 64² · HIGH 256² · ULTRA 256² |
| **MIPMAP** | `mipmap_quality` | **MED** | LOW +1 ring · MED identity · HIGH −1 · ULTRA −2 |

- Intact / out of scope: Hypha res / FOV / AA / AO / post / fog / cam / WARP / STREAM · Range mouse V/H · hip/ADS · READY HIP · powder · AIM TUNE · Augury remap / Tab · Beabim net · Soft-rim / death chrome · 4k atlases / new STREAM rings. Stamp pad **7×7**. Do **not** claim Hypha / Range / Augury / Beabim shipped this
- Detail: house `OPTIONS_SHELF.md` + `OPTIONS_TEXTURE.md` + `FULCRUMRUST_LAST_PASS_LOCK.md` + fulcrumRust [`docs/OPTIONS_TEXTURE_DIAL_SHEET.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/OPTIONS_TEXTURE_DIAL_SHEET.md). CREDITS / STEAL_MAP stay sources of truth

## Holding / locked intent — 1P viewmodel ≠ 3P biped gun (MP honesty; partial shipped #91 + #153)

Evan lock (2026-09-09 InitialVisuals). **Partial shipped #91** — peer biped hip gun stub (`reconstructed_gun`). **#153** held 3P clone — authored `kit_boxes` on the posed hip-hand. Hands / gear / Mixamo still **open**. Overnight cooks steal from `FULCRUMRUST_LAST_PASS_LOCK.md`. Goes with HANDS down the road.
...
| **Beabim** | 3P sync path — peer gun stub **landed #91**; peer shot muzzle **#119** uses that hip stub; PVP leftover **#133** (eye ray centered 1.60; 1P≠3P held); HOST session board **#139** (PVP radio pre-enter · no 127 invite seed); PVP honesty **#141** (`PeerBody::hurtboxes()` leftover · HP/AR Sync · unique pads); leftover ray **#147** (`LEFTOVER_HIT_M` **500 m** was 80 · flat `SMG_PELLET` **14** · Locus yard keeps own 80); KIND_SHOT loft + ballistic_A leftover **#160** (`KIND_SHOT.dir` HOST launch loft · hitscan stash); MP weapon honesty **#153** (`KIND_LOOT_WORLD` **15** · held 3P kit clone · hideout PeerBodies · hub no-loot / `HUB_PROTECT_SECS` **15`); KIND_* / hitboxes / loot UI consume Hypha metres; #143 hooks Hit not Sync; hands / gear still open |
| **Lab-Rat** | Stamps stay out |

## Holding / locked intent — hideout hub (soft leftover landed #153; metres pending)

Evan lock (2026-09-10 InitialVisuals). Beabim leftover **landed #153**. Floorplan metres stay **pending Evan tip**. Overnight cooks steal from `HIDEOUT_HUB.md` + fulcrumRust `docs/MP_WEAPON_DIAL_SHEET.md` — not chat. Do **not** invent hall / wing / ceiling numbers.
...
- **No-loot downs:** **landed #153** — in hideout, downs / hits do **not** drop a kit or seat a `KIND_BODY` bag. **Z** throw stays a player drop
- **15 s protect:** **landed #153** — `HUB_PROTECT_SECS` **15**. Both peers arm on a hub soft-down (`protect_ms` KIND_PVP bytes 22–23). Leftover ray + Hit apply gated until the window ends. Do **not** invent a second window. Not raid `1.20 s`
- **Hideout PeerBodies:** **landed #153** — starting-room remotes draw the same boxes + held clone as extract
- **Crisp flash:** still **pending** — hit feedback = crisp red → black flash → fade. **Not** Slain. **Not** death climb. Augury/Range chrome. #153 leftover is net/session gate + timer + no-loot only
- **Raid is normal:** **landed #153** — outside hideout / in world raid = loot, death, #143 wound feel, Beabim PvP. Extract keeps leftover ray + **1.20 s** leftover. No hub protect
...
| **Beabim** | Hideout PeerBody + no-loot + **15 s** protect + held 3P kit clone **landed #153** |
...
Powder **C** parked. Powder **B later landed #166**. Invented floorplan metres parked. Bigger progression / faction systems parked. Do **not** claim the hub volume or crisp flash chrome shipped.
...
Powder **C** parked. Powder **B later landed #166**. Invented floorplan metres parked. Bigger progression / faction systems parked. Do **not** claim the hub volume, hideout no-loot, or 15 s protect KIND shipped.
...
Powder **C** parked until Evan locks. Powder **B later landed #166**. Do **not** claim the climb, factions, void remesh, or safe-drop shipped.

## Holding / locked intent — Options shelf (remaps / Tab; mouse sens #163 + Graphics #164 + READY HIP #165 + TEXTURE/MIPMAP #172 landed)

Evan lock (2026-09-10 InitialVisuals). **Partial shipped #163 + #164 + #165 + #172** — Range Controls mouse V/H + hip/ADS · Hypha Graphics RES / FOV / AA / AA STR / AO / POST · Range **READY HIP** Chest/Low + two-pose **U** · Lab-Rat **TEXTURE / MIPMAP**. Rest **holding / locked intent**. Overnight cooks steal from `OPTIONS_SHELF.md` + fulcrumRust `docs/OPTIONS_MOUSE_SENS_DIAL_SHEET.md` + `docs/OPTIONS_GRAPHICS_DIAL_SHEET.md` + `docs/OPTIONS_TEXTURE_DIAL_SHEET.md` — not chat. Do **not** invent numeric defaults unless already tip-locked elsewhere. No code.

- **Closed (#163):** Controls **MOUSE H/V · HIP · ADS** on `LOOK_MUL` **0.25–2.00** / step **0.05** / default **1.00**. Persist `look_mul_h` / `look_mul_v` / `hip_look_mul` / `ads_look_mul`. Feel ADS **0.86** / blend **6.4** stay DNA
- **Closed (#164):** **RES** default **NATIVE** + Evan **3440×1440** + Steam survey **2560×1600 / 1920×1200 / 1366×768** · **FOV** hip base **90** · **AA** FXAA/OFF · **AA STR** live mix **0.5** · **AO** OFF/LOW/HIGH · **POST** OFF/LOW/HIGH. Persist `resolution` / `fov_hip` / `aa_type` / `aa_strength` / `ao_quality` / `post_quality`
- **Closed (#172):** **TEXTURE** default **HIGH** LOW 16² · MED 64² · HIGH 256² · ULTRA 256² · **MIPMAP** default **MED** LOW +1 · MED identity · HIGH −1 · ULTRA −2. Persist `texture_quality` / `mipmap_quality`. Ultra tex === High (`pbr=vendor` 256²). #152 crawl lock held. Chunk metres **16** stay
- **Intent (still holding):** remaps, Tab inventory press-toggle. Refer Concrete Echo for remap patterns
...
- **Closed (#165):** Gameplay **READY HIP** Chest (tip default, `hip` Y **−0.2128**) / Low (`hip_low` Y **−0.3528**). Persist `default_hip`. In-play **U** is that hip ↔ canted only. Shotgun Low-later is a parked hook — do **not** claim shipped
...
| **Range Tech** | **READY HIP** **landed #165**. Mouse V/H + hip/ADS **landed #163**; AIM TUNE PX-wall cook parallel; AIM TUNE LIVE per-kit pull **#167** + two-exe persist **#169** parallel. Powder **B later landed #166** |
| **Augury** | Input remapping (CE), Tab inventory press-toggle no hold-flash |
| **Beabim** | Off unless net-related |
| **Clerk** | `OPTIONS_SHELF.md` + `OPTIONS_MOUSE_SENS.md` + `OPTIONS_GRAPHICS.md` + `OPTIONS_TEXTURE.md` |

Invented default numbers parked. Powder **C** parked. Powder **B later landed #166**. PX clamp fix is Range cook, not this sheet’s implementation. Do **not** claim remaps / Tab press-toggle shipped. READY HIP **is** shipped #165. AIM TUNE LIVE **#167** + two-exe persist **#169** is shipped. V·H·ADS **is** shipped #163. Graphics RES/FOV/AA/AO/POST **is** shipped #164. TEXTURE / MIPMAP **is** shipped #172.

## Holding / locked intent — terrain tune iterator (underfoot + Refresh; not shipped)

Evan lock (2026-09-10 InitialVisuals). **Holding / locked intent — not shipped.** Overnight cooks steal from `TERRAIN_TUNE.md` — not chat. Do **not** invent numeric defaults beyond tip-locked dials already named. No invented step ranges. No code.

- **Intent:** live terrain tune panel — dials + **Refresh** / partial remesh (not full world regen). Aim-offset style iterator
- **Peek default (LOCKED):** **underfoot + Refresh** first (matches walk feel) — Hypha preference, Lab-Rat OK. Ghost cam is the **second** peek
- **Lab-Rat:** grit tile m · COL mix · `STABLE_LOCUS_RES` **16** / `MATERIAL_HOLD_M` **2.5** / `LUMA_GRAIN` ±**0.08** (#152) · desert `col` tile **2.8** · skirt quads **4** (#157) · `FULCRUM_UV` scale (existing mips only) · stamp rock lobe count / shade bias + refresh bake path
- **Hypha:** STREAM window / wide / resident (`StreamPolicy` / `FULCRUM_STREAM`) · fine `STREAM_RINGS` **11×11** · hold GPU·TTL · coalesce · horizon `visible=5/19` · desert rings **8** (#151) · prefetch / cook budget (hitch vs holes) + remesh
- **Explicit:** STREAM Options alone won’t kill most pop/noise — only grow fine cook. Texture crawl / grit flicker = Lab-Rat mips. Soft LOD pop inside a cell still parked. Soft RimHook / sand COL already tipped — iterator retunes, does **not** re-own chrome
...
## Holding / locked intent — ballistics spine (Powder B landed #166; C parked)

Evan lock (2026-09-10 InitialVisuals). Tip **#160 → #161 → #166** complete. **Beabim leftover/net half SHIPPED #160.** **Range loft DNA + AIM TUNE leftover stash SHIPPED #161.** **Range Powder B slightly hot service SHIPPED #166.** Overnight cooks steal from `BALLISTICS_SPINE.md` + fulcrumRust `docs/BALLISTICS_A_DIAL_SHEET.md` — not chat. Do **not** invent powder numbers, sample dt, or drag coeffs.

- **Closed leftover/net:** `KIND_SHOT` loft · `ballistic_A` default leftover · hitscan stash via `FULCRUM_LEFTOVER` / `leftover_hit` / `Session::set_leftover_hit_model`. Eye **1.60** · **500 m** · flat `SMG_PELLET` **14** held. Arc chord **0.17 m** (`HEAD_HALF_H + HURT_SKIN`) — not a powder dt
- **Closed Range loft:** 1P `muzzle_and_launch` + `hip_honest_dir` + MOA is `KIND_SHOT.dir`. Tracer streak steals `feel::step_ballistic`. End **MODEL** writes `leftover_hit`. TELE/PERF `LEFTOVER` reads it. No `ballistic_model`
- **Closed Powder B:** SR-25 muzzle **785 → 810** (steal M24). Gravity **9.8** / zero **100 m** held. Vacuum drop @ 420 m **1.403 → 1.317**. @ 500 m **1.988 → 1.867**. **A** restoreable. **C** arcade parked (`rifle_muzzle_speed() = None`). Drop = loft vacuum `0.5 · g · (range/speed)²`. No drag / Cd. Not `leftover_hit`
- **Locked leftover cook A (held):** physical bullets do colliding. HOST one shared launch solve drives leftover **and** peer streak. Client predicts visual only; HOST leftover is truth. **Not** hitscan as primary feel
- **Parked:** Powder **C** (friend-peek arcade) until Evan tips numbers; invented sample dt / drag coeffs; options B/C (loft-straight / arcade straighten) as interim only if yelled — default leftover cook is **A**

| Seat | Owns |
|------|------|
| **Beabim** | `KIND_SHOT` / leftover wire · HOST shared solve · fairness seed — **shipped #160** |
| **Range Tech** | `muzzle_and_launch` loft/zero · tracer DNA · model stash UI in AIM TUNE / debugger — **shipped #161** · Powder **B** tip — **shipped #166** |
| **Hypha / Lab-Rat / Augury** | Off |
| **Clerk** | `BALLISTICS_SPINE.md` |

Do **not** claim Powder C shipped. Hitscan stays stashed, not deleted.

## Holding / locked intent — hold pose spine (PreferredHand A; landed #168)

Evan lock (2026-09-10 InitialVisuals). **Partial shipped #168** — Range one right bank + sagittal HAND L/R mirror + HAND chrome + AIM TUNE HAND·kit·pose + ADS crosshair hide. Overnight cooks steal from `HOLD_POSE_SPINE.md` + fulcrumRust `docs/PREFERRED_HAND_A_DIAL_SHEET.md` — not chat. Do **not** invent dial numbers. No code.

- **Closed (#168 chrome):** **`HAND R` / `HAND L`** from **live hold X** (gun right of middle = HAND R). Not inverted `Shoulder` enum. Axis invert? **No**
- **Closed (#168 mirror):** one right bank + sagittal **−X / −yaw / −roll** (cant **0.785** → **−0.785**). Pitch / Y / Z stay. **No** `scale.x = −1`
- **Closed (#168 AIM TUNE):** shows **HAND · kit · pose**. Live-save schema **landed #167** (sibling persist — not this spine)
- **Closed (#168 hair):** 2D plus hides when `ads_factor` **> 0.5**. Hip + U-cycle canted keep it
...
| Seat | Owns |
|------|------|
| **Range Tech** | AIM TUNE / PreferredHand A — **landed #168** |
...
| **Clerk** | `HOLD_POSE_SPINE.md` + `PREFERRED_HAND_A.md` |

Do **not** claim Powder C shipped. READY HIP persist **is** shipped #165 (sibling). Powder **B later landed #166**. AIM TUNE LIVE **#167** is shipped (sibling persist).
...
- **H** — viewmodel **crossover shoulder / left-corner peek** on the existing FoW H bind (travel landed #59; tilt path **landed #84**; RH hip bias + slight straighten **landed #94**; one more body-width + ready-hip Y **landed #98**). **#168** live HAND flip + **`HAND R` / `HAND L`** chrome from live hold X (not inverted shoulder enum). Not a capsule/eye slide, not a mesh mirror. Live hip_low is **#99** shotgun low-ready (U-cycle glasses **LOW HIP**; LowHip ADS still irons). Live ads_cant is **#100** Greyzone CQC (glasses **CANT 45** / **CANT ADS**)
- **U** — two-pose play **#165**: Options READY HIP (Chest tip default / Low) ↔ Canted only. No Chest → LowHip → Canted ladder. Glasses still snap **LOW HIP** when Low is the seat · **CANT 45** on Canted. Viewmodel springs via `hold_spring` **7.0** (**landed #109**). **U** → CANT + RMB → `ads_cant` @ 60° CQC (**#100**). RMB from Chest/Low stays seated optic ads (Low still irons — **#99**)
- **Mouse5** — hold-cant ADS from any hold → `ads_cant` @ 60° CQC (**#100**). Does not steal U / RMB / melee
- **End** — live aim-offset / attachment tuner (landed #97). **AIM TUNE live-save landed #103** (End LIVE → Hypha `project.json`; `aim_live` default **true**; partial merge keeps #98/#99/#100). **AIM TUNE LIVE per-kit pull landed #167** (authored-sheet pull must not clobber other guns; apply snaps `hold_blend`). **AIM TUNE two-exe persist landed #169** (absolute `FULCRUM_SETTINGS` / cwd path · flush absorb · `project.json.lock`). **AIM TUNE PX travel landed #138** (`shoulder_x_max` **±0.50**; leftover +0.226 must not cap End +X; H still `shoulder_x_min` only). **AIM TUNE PX hideout wall landed #159** (`TUNE_POS_X_ABS` **0.50** floor · End home snap `hold_blend` · ATTACH same box; leftover +0.226 ≠ End box). **Wound feel / 1P screen-react landed #143** (suppress / armour / HP; 1P local; hooks Hit not Sync). **Canted optic + AIM TUNE ATTACH landed #150** (PageDown ATTACH OPTIC→CANTED→CAN; `attachments.canted`). Feel-lab Home remapped like X→Z. Insert WEAPON↔ATTACH · PageDown pose/attachment · PageUp step · ↑↓ axis · ←→ / num± nudge · Delete JSON. Glasses `AIM TUNE`. Ready-hip / H defaults stay **#98**; hip_low **#99**; ads_cant **#100**
