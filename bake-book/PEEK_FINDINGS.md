...
- Intact / out of scope: Lab-Rat texture / mip · Range #163 mouse V/H + hip/ADS · Augury remap / Tab · STREAM `StreamPolicy` · WINDOW / CA / GRAIN / DOF / FOG / CAM / WARP unchanged · Bloom / godRays no path. Do **not** add READY HIP rows. Do **not** claim Powder B. AIM TUNE LIVE **#167** already landed (sibling)
...
- Intact / out of scope: Powder A/B/C · READY HIP persist rows (do **not** restamp) · AIM TUNE LIVE **#167** already landed (sibling) · Options mouse V/H + hip/ADS · Hypha 3P lean · Lab-Rat stamps · Augury Home / death chrome. Leftover H dest ~**−0.041** is **not** the live left hold
...
- **Hip pose:** Do **not** add READY HIP persist rows on this shelf. Do **not** claim the hip toggle or Powder B landed. #168 play U stays two poses without restamping this seat
...
| **Range Tech** | Mouse V/H + hip/ADS **landed #163**; AIM TUNE PX-wall cook parallel; AIM TUNE LIVE per-kit pull **#167** parallel. Options default hip Chest vs Low + Powder B still cooking |
...
Invented default numbers parked. Powder A/B/C parked — do **not** claim landed. PX clamp fix is Range cook, not this sheet’s implementation. Do **not** claim remaps / Tab press-toggle / READY HIP shipped. AIM TUNE LIVE **#167** is shipped. V·H·ADS **is** shipped #163. Graphics RES/FOV/AA/AO/POST **is** shipped #164.
...
- **Parked:** full per-gun L+R banks · glasses N / numpad · Powder B · READY HIP persist rows (do **not** restamp)
...
Do **not** claim Powder B or READY HIP persist shipped. AIM TUNE LIVE **#167** is shipped (sibling persist).
