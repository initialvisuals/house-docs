...
- Intact / out of scope: powder A/B/C · Hypha STREAM · Augury · hub protect · `KIND_LOOT_WORLD` · Locus yard **80 m**. Range loft DNA + AIM TUNE stash **later landed #161**. Do **not** claim Hypha / Lab-Rat / Augury shipped this
...
- Intact / out of scope: powder A/B/C · KIND_SHOT encode / leftover collide / HOST shared solve (Beabim) · Hypha STREAM / PeerBody mesh · Lab-Rat stamps · Augury chrome · #147 500 m / eye 1.60 / hub protect / `KIND_LOOT_WORLD` · no-pause / `fulcrum://`. Do **not** claim Beabim / Hypha / Lab-Rat / Augury shipped this Range half
...
- Intact / out of scope: Hypha Graphics **later landed #164**. Lab-Rat texture / mip · Augury remap / Tab · AIM TUNE PX · stamps · death chrome. Do **not** add READY HIP rows. Do **not** claim Powder B. Do **not** invent implementation
...
- Intact / out of scope: Lab-Rat texture / mip · Range #163 mouse V/H + hip/ADS · Augury remap / Tab · STREAM `StreamPolicy` · WINDOW / CA / GRAIN / DOF / FOG / CAM / WARP unchanged · Bloom / godRays no path. READY HIP **#165** already landed (sibling). Do **not** claim Powder B. AIM TUNE LIVE **#167** already landed (sibling)
...
- Intact / out of scope: Powder A/B/C · READY HIP persist **#165** already landed (sibling — do **not** restamp) · AIM TUNE LIVE **#167** already landed (sibling) · Options mouse V/H + hip/ADS · Hypha 3P lean · Lab-Rat stamps · Augury Home / death chrome. Leftover H dest ~**−0.041** is **not** the live left hold
...
- **Parked (do not claim shipped):** Shotgun Low-later (`WeaponKind::default_hip_override` hook; day-one MP9-Z / SR-25 / M24 return `None`). PreferredHand HAND L/R Options chrome. Powder B still cooking. AIM TUNE LIVE **#167** already landed (sibling — do not restamp **#103**)
- **Dial sheet:**
...
- Intact / out of scope: mouse V/H · hip/ADS look mul (**#163** planted) · Hypha res / FOV / AA / AO / post / WARP / STREAM · Lab-Rat texture / mip · Augury remap / Tab · Powder A/B/C · PreferredHand mirror bank · stamps · Death chrome · AIM TUNE PX · authored pose numbers. Do **not** claim Beabim / Hypha / Lab-Rat / Augury shipped this
...
Powder A/B/C parked. Invented floorplan metres parked. Bigger progression / faction systems parked. Do **not** claim the hub volume or crisp flash chrome shipped.
...
| **Range Tech** | **READY HIP** **landed #165**. Mouse V/H + hip/ADS **landed #163**; AIM TUNE PX-wall cook parallel; AIM TUNE LIVE per-kit pull **#167** parallel. Powder B still cooking |
...
Invented default numbers parked. Powder A/B/C parked — do **not** claim landed. PX clamp fix is Range cook, not this sheet’s implementation. Do **not** claim remaps / Tab press-toggle shipped. READY HIP **is** shipped #165. AIM TUNE LIVE **#167** is shipped. V·H·ADS **is** shipped #163. Graphics RES/FOV/AA/AO/POST **is** shipped #164.
...
## Holding / locked intent — ballistics spine (powder parked)

Evan lock (2026-09-10 InitialVisuals). Tip **#160 → #161** complete. **Beabim leftover/net half SHIPPED #160.** **Range loft DNA + AIM TUNE leftover stash SHIPPED #161.** Overnight cooks steal from `BALLISTICS_SPINE.md` + fulcrumRust `docs/BALLISTICS_A_DIAL_SHEET.md` — not chat. Do **not** invent powder numbers, sample dt, or drag coeffs.
...
- **Closed Range:** 1P `muzzle_and_launch` + `hip_honest_dir` + MOA is `KIND_SHOT.dir`. Tracer streak steals `feel::step_ballistic`. End **MODEL** writes `leftover_hit`. TELE/PERF `LEFTOVER` reads it. No `ballistic_model`
- **Locked cook A (held):** physical bullets do colliding. HOST one shared launch solve drives leftover **and** peer streak. Client predicts visual only; HOST leftover is truth. **Not** hitscan as primary feel
...
| **Range Tech** | `muzzle_and_launch` loft/zero · tracer DNA · model stash UI in AIM TUNE / debugger — **shipped #161** |
...
- **Parked:** full per-gun L+R banks · glasses N / numpad · Powder B. READY HIP persist **already landed #165** (sibling — do **not** restamp)
...
Do **not** claim Powder B shipped. READY HIP persist **is** shipped #165 (sibling). AIM TUNE LIVE **#167** is shipped (sibling persist).
