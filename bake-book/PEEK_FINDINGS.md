...
- Intact / out of scope: Range 1P / AIM TUNE (`SUPPORT_STEP` **0.25** stays) · Beabim KIND_* / HOST / leftover PVP (#133) · Lab-Rat stamps / CHANNELS / pedon / spawns · Augury Home · STREAM amortize (#123) · #131 biped branch (**later landed #131**). Hop vertical-before-XZ **later landed #149**. Do **not** claim Range / Beabim / Lab-Rat / Augury shipped this
- Detail: house `FULCRUMRUST_LAST_PASS_LOCK.md` + fulcrumRust [`docs/LANDMARK_RIDE.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/LANDMARK_RIDE.md). STEAL_MAP / CREDITS stay sources of truth. Hop ride: Closed by #149
...
- Detail: house `FULCRUMRUST_LAST_PASS_LOCK.md` + fulcrumRust [`docs/WOUND_FEEL_DIAL_SHEET.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/WOUND_FEEL_DIAL_SHEET.md). CREDITS / STEAL_MAP / WOUND_FEEL_DIAL_SHEET stay sources of truth. Death / Slain: Closed by #146
...
- **Landmark hop ride — vertical before XZ** — Hypha. Thin follow-up to [#136](https://github.com/initialvisuals/fulcrumRust/pull/136). Space hop onto rock/prop lids was still shoving XZ because hop applied XZ before vertical, so the first-frame ~0.20 m lift never entered `RIDE_STEP`. [PR #149](https://github.com/initialvisuals/fulcrumRust/pull/149) (`ff540315`). Seat: **Hypha** owns landmark ride. Soft dials only — not a mesher rewrite, not STREAM, not Lab-Rat stamps. No new hop dial — #136 numbers cover jump. STEAL_MAP / CREDITS already claimed in-PR — house shelf only. Do **not** invent A-note PRs. Do **not** claim Range / Beabim / Lab-Rat / Augury shipped this
- **Closed (hop shove-off):** local pawn applies **vertical before XZ**. A Space hop enters `RIDE_STEP` so hop-onto / land on a 0.44–0.7 m lid does not shove. Camera `push_out_of_walls` skips a box the hop-eye is standing above
- **Dial sheet (held from #136):**

| Dial | Value | Notes |
|------|-------|-------|
| `RIDE_STEP` | **0.50** | Held. Feet this far below an AABB top ride as floor |
| `RIDE_SKIN` | **0.06** | Held. Planted-sole hysteresis; hop-eye above a lid too |
| `SUPPORT_STEP` | **0.25** | Held. Range #79 leftover FX stay on the 0.25 column |
| Hop | same band | Vertical before XZ. No extra hop dial |

- **#136 / #88 (held)** — ride band + FOLLOW / DEADZONE / RISE / SINK unchanged
- Intact / out of scope: Range 1P / AIM TUNE · Beabim KIND_* / HOST · Lab-Rat stamps / CHANNELS / pedon · Augury Home / Slain · STREAM amortize. Do **not** claim Range / Beabim / Lab-Rat / Augury shipped this
