...
- **Controls** — Look scale sits on feel-lab sens: `LOOK_MUL` default **1.0**, min **0.25**, max **2.0**, step **0.05**; Invert Y toggle. Binds stay README. Hint: `LOOK SITS ON FEEL-LAB SENS · BINDS IN README`. **Later landed #163** — split **MOUSE H/V · HIP · ADS** on that same lock (persist `look_mul_h` / `look_mul_v` / `hip_look_mul` / `ads_look_mul`). **Later landed #164** — Graphics **RES / FOV / AA / AA STR / AO / POST**
...
- Intact / out of scope: Hypha STREAM / remesh / chunk 16 / RimHook / landmark ride · Range powder / AIM TUNE / PreferredHand · Beabim KIND / net · Augury Slain / glasses · pycelium-win GPU mesocosm · CHANNELS remesh · a fourth named plot · Options texture / mip. Do **not** claim Range / Hypha / Beabim / Augury shipped this
...
- Intact / out of scope: Hypha Graphics **later landed #164**. Lab-Rat texture / mip · Augury remap / Tab · AIM TUNE PX · stamps · death chrome. READY HIP **later landed #165**. Powder **B later landed #166**. Do **not** invent implementation
...
- Intact / out of scope: Lab-Rat texture / mip · Range #163 mouse V/H + hip/ADS · Augury remap / Tab · STREAM `StreamPolicy` · WINDOW / CA / GRAIN / DOF / FOG / CAM / WARP unchanged · Bloom / godRays no path. READY HIP **#165** already landed (sibling). Powder **B later landed #166**. AIM TUNE LIVE **#167** already landed (sibling)
...
- Intact / out of scope: mouse V/H · hip/ADS look mul (**#163** planted) · Hypha res / FOV / AA / AO / post / WARP / STREAM · Lab-Rat texture / mip · Augury remap / Tab · Powder **C** · PreferredHand mirror bank · stamps · Death chrome · AIM TUNE PX · authored pose numbers. Do **not** claim Beabim / Hypha / Lab-Rat / Augury shipped this. Powder **B later landed #166**
...
## Holding / locked intent — Options shelf (remaps / Tab; mouse sens #163 + Graphics #164 + READY HIP #165 landed)

Evan lock (2026-09-10 InitialVisuals). **Partial shipped #163 + #164 + #165** — Range Controls mouse V/H + hip/ADS · Hypha Graphics RES / FOV / AA / AA STR / AO / POST · Range **READY HIP** Chest/Low + two-pose **U**. Rest **holding / locked intent**. Overnight cooks steal from `OPTIONS_SHELF.md` + fulcrumRust `docs/OPTIONS_MOUSE_SENS_DIAL_SHEET.md` + `docs/OPTIONS_GRAPHICS_DIAL_SHEET.md` — not chat. Do **not** invent numeric defaults unless already tip-locked elsewhere. No code.
...
- **Intent (still holding):** remaps, Tab inventory press-toggle. Refer Concrete Echo for remap patterns. Lab-Rat texture / mipmap stay out
