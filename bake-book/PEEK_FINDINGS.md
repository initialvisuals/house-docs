...
- Intact: #76 SIM-only · **P** unused · one HoB + gravity / zero model · #67 hip honesty · **[ / ]** ToD · **, / .** clouds · **/** HDRI. Do **not** reopen arcade/**P**, heat color, first big-map, `dBXpg`
...
- Intact: hop 12/30/1 · #78 hold-O / −/= / grounded slide · #76 SIM-only · **P** unused · Augury extract popup still **~**. Do **not** claim a second land system, Augury popup, Lab-Rat slope/PBR, or first big-map
