...
- Options shelf (FoW settings UI — **READY HIP landed #165** Chest/Low + two-pose U; remaps / Tab press-toggle still **holding**; Range mouse V/H + hip/ADS **landed #163**; Hypha Graphics **RES / FOV / AA / AA STR / AO / POST landed #164**; Lab-Rat **TEXTURE / MIPMAP landed #172**) → [`OPTIONS_SHELF.md`](OPTIONS_SHELF.md) + house pointers [`OPTIONS_MOUSE_SENS.md`](OPTIONS_MOUSE_SENS.md) + [`OPTIONS_GRAPHICS.md`](OPTIONS_GRAPHICS.md) + [`OPTIONS_TEXTURE.md`](OPTIONS_TEXTURE.md) → fulcrumRust [`docs/OPTIONS_MOUSE_SENS_DIAL_SHEET.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/OPTIONS_MOUSE_SENS_DIAL_SHEET.md) + [`docs/OPTIONS_GRAPHICS_DIAL_SHEET.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/OPTIONS_GRAPHICS_DIAL_SHEET.md) + [`docs/OPTIONS_DEFAULT_HIP_DIAL_SHEET.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/OPTIONS_DEFAULT_HIP_DIAL_SHEET.md) + [`docs/OPTIONS_TEXTURE_DIAL_SHEET.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/OPTIONS_TEXTURE_DIAL_SHEET.md)
...
- Locus Voidspore yard leftover (Lab-Rat **#171** — matrix **10×4×10** · max live **48** · tip purple `[0.68, 0.20, 0.86]` · origin XZ **−3.55, 2.35** · `FULCRUM_VOIDSPORE=0` kills; ink + purple tips left of spawn; not a fourth plot / STREAM remesh / glasses / AI) → house pointer [`VOIDSPORE.md`](VOIDSPORE.md) → fulcrumRust [`docs/VOIDSPORE_DIAL_SHEET.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/VOIDSPORE_DIAL_SHEET.md)
