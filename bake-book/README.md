...
- Locus Voidspore yard leftover (Lab-Rat **#171** — matrix **10×4×10** · max live **48** · tip purple `[0.68, 0.20, 0.86]` · origin XZ **−3.55, 2.35** · `FULCRUM_VOIDSPORE=0` kills; ink + purple tips left of spawn; not a fourth plot / STREAM remesh / glasses / AI; Options texture / mip still cooking) → house pointer [`VOIDSPORE.md`](VOIDSPORE.md) → fulcrumRust [`docs/VOIDSPORE_DIAL_SHEET.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/VOIDSPORE_DIAL_SHEET.md)
