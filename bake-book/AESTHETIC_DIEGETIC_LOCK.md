...
- Aim-offset tuner (fulcrumRust #97): **End** opens the live viewmodel / attachment offset sheet on existing ViewmodelDials + kit_mesh optic/can sockets; glasses `AIM TUNE` only — never a numeric ammo HUD. #97 End tuner nudges **#98** authored defaults
