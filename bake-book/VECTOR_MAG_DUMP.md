...
**Sibling:** heat cards stay on [`../heat-card-dial-sheet.md`](../heat-card-dial-sheet.md) — this sheet is muzzle / FX, not heat. Do **not** reopen orange cards. **#89** did **not** retune HeatDials (`#66` / `#71` stay).
...
Local light / optic remain **reference-only** unless already on the feel sheet. Heat stays on `heat-card-dial-sheet.md` (#66 / #71). CE tip **0.2.8** preferred if a later cook retunes muzzle-adjacent haze — not a heat-card rewrite.

## Not this shelf

Pixellation / dither walls and floor warp are **Hypha Graphics / Augury**. Do **not** claim them here. Do **not** invent bloom / godRays paths (`#86` parked those). Do **not** reopen heat orange cards (`#66` / `#71` stay). **#89** did not ship a kit mesh rewrite, Aim-offset Home debugger, Beabim sync, or profile onboard.
...
- Heat stay on `heat-card-dial-sheet.md` + Hypha `#66` colorless post. No orange card redraw
- Intact siblings: `#12` flash/spark/mark · `#19`/`#47` draw-distance · `#51` barrel +Z · `#67` kit-tip spawn · `#71` heat blend · `#76` SIM · `#79` heightfield snap · **`#89` live steal**
