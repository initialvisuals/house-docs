...
Clerk shelf cook pulse after the missed 2026-09-08 run. Steal dials from this shelf + fulcrumRust `docs/STEAL_MAP.md` + `docs/BIPED_3P_DIAL_SHEET.md` + `docs/LANDMARK_RIDE.md` + `docs/PVP_DIAL_SHEET.md` — not chat.

**Pulse:** Hypha #131 3P biped eye **1.60** / head **1.62** centered + PeerBody lean/ragdoll · landmark AABB ride **#136** · Beabim HOST PVP radio pre-enter
...
| **Clerk** | Patch A ledger #72/#74/#75/#92/#95/#104/#105 + CREDITS trails; bake-book shelves through #139 (Beabim HOST session board) + #136 (Hypha landmark AABB ride) + #131 (Hypha 3P biped / PeerBody) |

## Still cooking

| Seat | Open |
|------|------|
| **Hypha** | Stream hitch *fix* **#108** + **#123** landed (cook=1/2 · prefetch=5 m · `defer=worker/paint/gpu`). Soft LOD pop inside a chunk parked. Scope glass holding until LPVO. Bloom/godRays no path. |
