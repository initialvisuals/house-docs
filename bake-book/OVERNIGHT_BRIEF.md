...
**Pulse:** Hypha play STREAM **11×11** + warm hold **#137** (r=5 · prefetch=5+heading · hold=2/12) · #131 3P biped eye **1.60** / head **1.62** centered + PeerBody lean/ragdoll · landmark AABB ride **#136** · Beabim HOST PVP radio pre-enter
...
- **1P viewmodel ≠ 3P biped gun** — **partial #91** (peer biped hip stub). Range owns 1P / AIM TUNE; **Hypha** owns 3P peer presentation / PeerBody (**landed #131**); Beabim owns KIND_* / hitboxes / loot UI (consumes death/ragdoll hooks). Full kit honesty / hands / gear still open.
...
| **Clerk** | Patch A ledger #72/#74/#75/#92/#95/#104/#105 + CREDITS trails; bake-book shelves through #137 (Hypha play STREAM 11×11 + warm hold) + #139 (Beabim HOST session board) + #136 (Hypha landmark AABB ride) + #131 (Hypha 3P biped / PeerBody) |
...
| **Beabim** | World/sim leftover **landed #119**. No-pause + KIND_RAID handshake **landed #122**. PVP leftover **landed #133** (KIND_PVP default off · hide names · KIND_BRASS · eye 1.60/1.62 · rim respawn). HOST session board **landed #139** (PVP radio pre-enter · no 127 invite seed). Range feel / knife-rally / joiner slash / stabilize / stamps / hatch still local. Ragdoll visual flop **landed #131** (Hypha PeerBody — Beabim consumes death/ragdoll hooks only). Server browser parked. Full 3P kit honesty / hands / gear open. |
