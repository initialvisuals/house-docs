...
| **hip_low** | Y stays #94 **−0.2788** (U-cycle low stance; no new shotgun pose). +X/+Z only on #98 |
| **Not** | A capsule / eye slide. Mesh mirror / `scale.x = −1`. Infinite travel. Inward yaw to fake aim. New low-hip / shotgun pose |
...
| **Seat** | Range Tech. Same #59 feel PR as lean flip / hop / heat look / distant hit. Tilt path **#84**. First +0.08 / left hold **#94**. Live hip / ready-Y **#98** |

See `PEEK_FINDINGS.md` Closed by #59 / Closed by #84 / Closed by #94 / Closed by #98 + H shoulder-swap tilt (#84) + Patch A RH hip bias (#94) + RH body-width + ready-hip Y (#98).
...
| Seat | Owns |
|------|------|
| **Range Tech** | H travel (#59) + tilt path (#84). First +0.08 / left hold **#94**. Live hip / ready-Y **#98** |
| **house / Hypha** | PreferredHand + new-profile onboard — **parked**. Do **not** claim shipped |

Live hip / `shoulder_cross` / left tilt **superseded #98** (after #94 first +0.08) — hip **0.2403 / −0.2128 / −0.1833**; `shoulder_cross_x` **−0.281** / `shoulder_cross_y` **0.032**; pitch/yaw/roll **0.04 / 0.10 / 0.08** (slight straighten, not chest-cross cant). hip_low Y stays #94 **−0.2788**. See RH hip one more body-width + ready-hip Y (#98).
...
See `PEEK_FINDINGS.md` Closed by #94. Live **End** tuner on these same dials **landed #97**. Live hip / ready-Y **superseded #98** — hip_low Y stays this #94 low stance.
...
#97 End tuner nudges **#98** authored defaults (MP9-Z hip **0.2403 / −0.2128 / −0.1833**; ADS iron X **0.0084**; SR-25 / M24 hip **0.256 / −0.224 / −0.208** / **0.261 / −0.229 / −0.228**; `shoulder_cross_x` **−0.281** / `shoulder_cross_y` **0.032**; hip_low Y stays #94 **−0.2788**; left hold slight straighten stays). Kit boxes + muzzle tip follow live can/optic offsets. World drops stay authored identity.
...
| MP9-Z `hip_low` X / Y / Z | 0.1843 / −0.2788 / −0.1753 | **0.2403 / −0.2788 / −0.1633** (Y stays #94 low stance; +X/+Z only) |
...
**Not** a mesh mirror, not a new low-hip / shotgun pose, no inward yaw to fake aim. #89 tracers / particles stay. Tip spawn + `hip_honest_dir` unchanged. #97 End tuner still live for fine polish on these same dials.
...
See `PEEK_FINDINGS.md` Closed by #98. #97 End tuner nudges these **#98** authored defaults.
...
- PreferredHand + new-profile onboard — **parked** house/Hypha. **#84** / **#94** / **#97** / **#98** did **not** ship it
...
Range Tech RH hip one more body-width + ready-hip Y (MP9-Z hip **0.2403 / −0.2128 / −0.1833** was #94 0.1843 / −0.1688 / −0.1953; +0.056 X = 2 × MP9 `receiver_half.x` 0.028; Y **−0.044** ready-hip drop; Z **+0.012** tighter; `hip_low` Y stays #94 **−0.2788**; hip_low/hip_cant +X/+Z only; sprint_high X **0.29 → 0.346**; SR-25 hip **0.256 / −0.224 / −0.208**; M24 hip **0.261 / −0.229 / −0.228**; `shoulder_cross_x` **−0.281** / `shoulder_cross_y` **0.032** keeps H dest ~−0.041 X / ~−0.181 Y; `shoulder_x_min` **−0.055**; ADS X / left pitch/yaw/roll **0.04 / 0.10 / 0.08** unchanged; #97 End tuner still live on these #98 defaults; not a mesh flip / new shotgun pose / Beabim / heat / terrain / PreferredHand onboard): fulcrumRust PR #98 (2026-09-09) — **landed**. `48518709` / `5b02e2ab`. See `PEEK_FINDINGS.md` Closed by #98.
