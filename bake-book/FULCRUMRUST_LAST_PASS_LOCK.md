...
Do **not** claim STREAM remesh · CHANNELS compile · glasses elbow · AI / combat · a fourth named plot · Options texture / mip · pycelium GPU mesocosm. #154 hideout HOLO stays the hideout leftover. Quiet grit thumbs stay.
...
Intact / out of scope: mouse V/H · hip/ADS look mul (**#163** planted — not restamped) · Hypha res / FOV / AA / AO / post / WARP / STREAM · Lab-Rat texture / mip · Augury remap / Tab · Powder **C** · PreferredHand mirror bank · stamps · Death chrome · AIM TUNE PX · authored pose numbers. Do **not** claim shotgun Low / PreferredHand chrome / Powder C shipped. Powder **B later landed #166**. AIM TUNE LIVE **#167** already landed (sibling).
...
**Still local / other seat (deliberately):** Hypha res / FOV / AA / AO / POST **later landed #164** · WARP / STREAM · Lab-Rat texture / mip / `lod_mips` · Augury remap / Tab inventory · PreferredHand A chrome **later landed #168** · AIM TUNE PX box · stamps · death chrome. Options READY HIP **later landed #165**. Powder **B later landed #166**. AIM TUNE LIVE **#167** already landed (sibling). Do **not** invent implementation. Do **not** claim Hypha / Lab-Rat / Augury / Beabim shipped this.
...
**Still local / other seat (deliberately):** Lab-Rat texture / mipmap · Range mouse V/H + hip/ADS (**#163**) · Augury remaps + Tab · STREAM `StreamPolicy` · Powder **B later landed #166** · PreferredHand / ballistics leftover / AIM TUNE · Beabim net · Bloom / godRays / brightness / gamma (**#86** no path). READY HIP **later landed #165**. AIM TUNE LIVE **#167** is Range parallel. Do **not** claim Range / Lab-Rat / Augury / Beabim shipped this.
