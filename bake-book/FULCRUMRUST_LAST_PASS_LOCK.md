...
See `PEEK_FINDINGS.md` Closed by #110. Hitch *fix* shelf: Closed by #108. LOGS COPY / tracks: Closed by #121. Occlusion + probes: Closed by #125.
...
| **Hypha** | Stream hitch leftover #123 — not this cook. #108 amortize not rewritten |

Out of scope (do **not** claim shipped by #125): Hypha #123 hitch amortize / STREAM refill · End AIM TUNE · Lab-Rat stamps/crawl consume · Range tip/optic consume · Beabim MP · timed surface kill.

See `PEEK_FINDINGS.md` Closed by #125. Foundation: Closed by #110. LOGS COPY / tracks: Closed by #121. Hitch *fix* shelf: Closed by #108.
