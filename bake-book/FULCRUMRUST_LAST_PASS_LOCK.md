...
Do **not** claim NRM/GLOSS GPU bind · remesh · chunk resize · STREAM bump · Range / Hypha / Beabim / Augury shipped this. #80 slope/PBR plugs + #101 UV sheet + #112 consume stay the prior layers. Grit/COL LOD luma crawl stop **later landed #152**.
...
See `PEEK_FINDINGS.md` Closed by #152 + fulcrumRust `docs/STAMP_PBR_DIAL_SHEET.md` + `docs/CHANNELS.md` + `docs/TERRAIN.md`.
