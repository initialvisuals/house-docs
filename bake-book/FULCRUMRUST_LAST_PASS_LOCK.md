...
See `PEEK_FINDINGS.md` Closed by #147 + fulcrumRust `docs/PVP_DIAL_SHEET.md`. MP weapon honesty + hideout hub: Closed by #153. Ballistics A leftover: Closed by #160.

## Ballistics A leftover / KIND_SHOT loft (Beabim — landed #160)

Evan lock. **Shipped** [fulcrumRust #160](https://github.com/initialvisuals/fulcrumRust/pull/160) (2026-09-10, merge `e0803dc1967418fef7bdd7e04a31c2a3b2f681ed`). Seat: **Beabim** owns leftover/net only. House `BALLISTICS_SPINE` cook **A**. Hitscan stashed, not deleted. Extends #119 KIND_SHOT + #147 leftover ray. Range Tech loft DNA + AIM TUNE stash chrome still **open** (tip [#161](https://github.com/initialvisuals/fulcrumRust/pull/161) CONFLICTING — do **not** claim shipped; do **not** invent a merge). CREDITS + STEAL_MAP + `BALLISTICS_A_DIAL_SHEET` already claimed in-PR. Canonical dial sheet: fulcrumRust [`docs/BALLISTICS_A_DIAL_SHEET.md`](https://github.com/initialvisuals/fulcrumRust/blob/main/docs/BALLISTICS_A_DIAL_SHEET.md). Overnight cooks steal these numbers from the sheet — not every `.rs`. Do **not** invent dials.
...
**Still local / other seat (deliberately):** Range AIM TUNE chrome / powder A/B/C / tracer visual DNA · Hypha STREAM · Augury · hub protect · `KIND_LOOT_WORLD` · Locus yard **80 m**. Do **not** claim Range / Hypha / Lab-Rat / Augury shipped this.

See `PEEK_FINDINGS.md` Closed by #160 + fulcrumRust `docs/BALLISTICS_A_DIAL_SHEET.md` + house `BALLISTICS_SPINE.md`.
