...
| **Lab-Rat** | Probe JSON consume for stamps / crawl / CHANNELS stays **·** |
| **Hypha** | Stream hitch leftover #123 — not this cook (**later landed #123**). #108 amortize not rewritten |

Out of scope (do **not** claim shipped by #125): Hypha hitch *fix* deepen (**later landed #123**) / STREAM refill · End AIM TUNE · Lab-Rat stamps/crawl consume · Range tip/optic consume · Beabim MP · timed surface kill.
...
Augury Home occlusion + 3D probes + COLL/PERF/SPWN (tabs **LOGS / TELE / COLL / PERF / SPWN / CHEAT**; **P** drop look-at probe cap **32**; TELE/COLL/PERF **Enter** copies `fulcrum.probes` / `FULCRUM_PROBES`; schema `fulcrum.probes.v1`; soft Enter debounce **0.45s**; fills under glyphs; INV/STATUS / HP-AR / Options / JOIN HOLD unsmashed; Lab-Rat/Range consume stay **·**; End AIM TUNE stays Range; hitch *fix* deepen **later landed #123**; timed surface kill still **~**): fulcrumRust PR #125 (2026-09-09) — **landed**. `317d58fd6788d1b9b12ef28ba211becd1c621678`. See `PEEK_FINDINGS.md` Closed by #125. Hitch *fix*: Closed by #108 / Closed by #123.
