...
**Still local / other seat (deliberately):** Range 1P feel / AIM TUNE / HoB / heat / SFX / eject dials · Lab-Rat stamps / pedon / CHANNELS · Hypha STREAM / mesher (#137 11×11 + hold=2/12 stay; consume height / PeerBody metres only — do **not** claim Hypha shipped this leftover) · Augury Home binds / hatch glasses · party name exception · Range **2.5× head** · Mixamo / full 3P kit honesty / hands / gear · server browser / dedicated infra. Do **not** claim Range / Hypha / Lab-Rat / Augury shipped this.

See `PEEK_FINDINGS.md` Closed by #141 + fulcrumRust `docs/PVP_DIAL_SHEET.md`.
...
Beabim PVP honesty (PeerBody leftover volumes ride `PeerBody::hurtboxes()` lean/crouch/loco/ragdoll — not the short leftover 5-box; hurt skin **0.06** + swept AABB + **4** substeps; inclusive slab; KIND_PVP Hit / **Sync** + WELCOME remaining HP/AR — HOST/JOIN glasses `HP n  AR n` + diegetic bars, armor first; unique rim pads WELCOME host **0** / join+respawn rotate / occupancy claims + peer feet within **16 m** / knock-off if stacked; eye ray stays centered **1.60**; downs still **1.20 s**; Range eject dials untouched; Hypha STREAM / #137 11×11 untouched; Lab-Rat stamps / pedon / CHANNELS untouched; house lock **1P≠3P** held; no-pause held; server browser parked): fulcrumRust PR #141 (2026-09-09) — **landed**. `dc94c810`; merge tip `cb9c20a3`. See `PEEK_FINDINGS.md` Closed by #141 + fulcrumRust `docs/PVP_DIAL_SHEET.md`.
