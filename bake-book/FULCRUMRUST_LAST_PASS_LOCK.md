...
See `PEEK_FINDINGS.md` Closed by #59 / Closed by #84 / Closed by #94 / Closed by #98 / Closed by #99 / Closed by #100 / Closed by #109 / Closed by #113 / Closed by #116 / Closed by #138 / Closed by #159 / Closed by #168 + H shoulder-swap tilt (#84) + Patch A RH hip bias (#94) + RH body-width + ready-hip Y (#98) + low-hip shotgun stance (#99) + canted CQC ADS (#100) + U-cycle hold springs (#109) + kit handling / ergo / MOA (#113) + PreferredHand onboard (#116) + AIM TUNE PX travel (#138) + AIM TUNE PX hideout wall (#159) + PreferredHand A (#168).
...
| **Gameplay** | Glasses labels toggle + crosshair toggle (real — drop quads when off). **#168** hides the 2D plus when `ads_factor` **> 0.5**; hip + U-cycle canted keep it. Hint: `SHOOT FEEL STAYS · ENTER TOGGLE` |
...
| **Persist** | `project.json` in cwd, or `FULCRUM_SETTINGS=/path/to.json`. #82 `output_device` · **#90** `warp_strength` · **#103** `aim_live` / `aim_tune.*` (**#167** per-kit pull — authored kits keep persisted peeks) · **#116** `profile_onboarded` / `preferred_hand` · **#163** `look_mul_h` / `look_mul_v` / `hip_look_mul` / `ads_look_mul` · **#164** `resolution` / `fov_hip` / `aa_type` / `aa_strength` / `ao_quality` / `post_quality` live on the same file |
...
Range Tech Options mouse V/H + hip/ADS (Controls **MOUSE H** / **MOUSE V** / **HIP** / **ADS** on the existing #46 `LOOK_MUL` lock **1.00** / **0.25–2.00** / step **0.05**; persist `look_mul_h` / `look_mul_v` / `hip_look_mul` / `ads_look_mul`; old `look_mul` seeds both mouse axes when split keys are absent; feel-lab `look_sens` **0.0022** + feel ADS **0.86** / blend **6.4** stay DNA; Invert Y stays; Options default hip Chest vs Low + Powder B still cooking — do **not** claim landed; Hypha res/FOV/AA/AO/post/WARP/STREAM · Lab-Rat texture/mip · Augury remap/Tab · PreferredHand · AIM TUNE PX left alone): fulcrumRust PR #163 (2026-09-10) — **landed**. Merge `96e4410e`. See `PEEK_FINDINGS.md` Closed by #163 + house `OPTIONS_SHELF.md` + fulcrumRust `docs/OPTIONS_MOUSE_SENS_DIAL_SHEET.md`.
