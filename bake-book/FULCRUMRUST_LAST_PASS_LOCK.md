...
- Parked / still TODO (do not claim done): death cam; teammate net stabilize; timed surface kill; full extract loot loop. Ragdoll visual flop **later landed #131** `PeerBody`. Leftover hurt volumes **later landed #141** (`PeerBody::hurtboxes()` + skin **0.06** + sweep **4**)
