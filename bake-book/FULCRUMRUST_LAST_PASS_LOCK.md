...
| **Beabim** | 3P sync path — peer gun stub **landed #91**; peer shot muzzle **#119** uses that hip stub; KIND_* / hitboxes / loot UI (consume Hypha metres); PVP leftover **#133**; HOST session board **#139**; PVP honesty **#141** (`PeerBody::hurtboxes()` leftover · HP/AR Sync · unique pads); full kit honesty still open |
| **Lab-Rat** | Stamps stay out |

See `PEEK_FINDINGS.md` Holding / locked intent — 1P ≠ 3P + Closed by #91 + Closed by #119 + Closed by #131 + Closed by #141.
...
See `PEEK_FINDINGS.md` Closed by #133 + fulcrumRust `docs/PVP_DIAL_SHEET.md`. HOST session board / no-127 invite: Closed by #139. PVP honesty / PeerBody leftover / HP-AR Sync / unique pads: Closed by #141.
...
See `PEEK_FINDINGS.md` Closed by #139 + fulcrumRust `docs/PVP_DIAL_SHEET.md`. PVP honesty: Closed by #141.
...
See `PEEK_FINDINGS.md` Closed by #141 + fulcrumRust `docs/PVP_DIAL_SHEET.md`. Wound feel / 1P screen-react: Closed by #143.
...
| **Augury** | **Death / Slain stays Augury** (#36 `DOWNED` / `DEAD` / bag). Do **not** claim #143 shipped slain chrome |
...
See `PEEK_FINDINGS.md` Closed by #143 + fulcrumRust `docs/WOUND_FEEL_DIAL_SHEET.md`.
...
Beabim PVP honesty (PeerBody leftover volumes ride `PeerBody::hurtboxes()` lean/crouch/loco/ragdoll — not the short leftover 5-box; hurt skin **0.06** + swept AABB + **4** substeps; inclusive slab; KIND_PVP Hit / **Sync** + WELCOME remaining HP/AR — HOST/JOIN glasses `HP n  AR n` + diegetic bars, armor first; unique rim pads WELCOME host **0** / join+respawn rotate / occupancy claims + peer feet within **16 m** / knock-off if stacked; eye ray stays centered **1.60**; downs still **1.20 s**; Range eject dials untouched; Hypha STREAM / #137 11×11 untouched; Lab-Rat stamps / pedon / CHANNELS untouched; house lock **1P≠3P** held; no-pause held; server browser parked; Range wound feel **later landed #143**): fulcrumRust PR #141 (2026-09-09) — **landed**. `dc94c810`; merge tip `cb9c20a3`. See `PEEK_FINDINGS.md` Closed by #141 + fulcrumRust `docs/PVP_DIAL_SHEET.md`.
Range Tech 1P screen-react / wound feel (suppress-near soft short blur only; armour jostle + soft blur, **no red**; HP stronger jostle + blur + red fade; envelope `--===--------` ramp→front peak→tail; never full-strength blur; 1P local only; Hypha consumes `post.wound = [blur, red, 0, 0]`; hooks Beabim `KIND_PVP` Hit not Sync; Death/Slain stays Augury; #141 leftover / AIM TUNE / heat lattice / stamps untouched): fulcrumRust PR #143 (2026-09-09) — **landed**. `ae09f5f8`. See `PEEK_FINDINGS.md` Closed by #143 + fulcrumRust `docs/WOUND_FEEL_DIAL_SHEET.md`.
