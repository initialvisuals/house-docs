...
Authored `hip` / `hip_low` / `hip_cant` + AIM TUNE WEAPON poses stay. Play does not cycle all three. PreferredHand A chrome **not** this cook — READY HIP intersects the hold/grip pose home without inventing HAND L/R Options. Powder B still cooking. AIM TUNE LIVE **#167** already landed (sibling — do not restamp **#103**).
...
Intact / out of scope: mouse V/H · hip/ADS look mul (**#163** planted — not restamped) · Hypha res / FOV / AA / AO / post / WARP / STREAM · Lab-Rat texture / mip · Augury remap / Tab · Powder A/B/C · PreferredHand mirror bank · stamps · Death chrome · AIM TUNE PX · authored pose numbers. Do **not** claim shotgun Low / PreferredHand chrome / Powder B shipped. AIM TUNE LIVE **#167** already landed (sibling).
...
See `PEEK_FINDINGS.md` Closed by #147 + fulcrumRust `docs/PVP_DIAL_SHEET.md`. MP weapon honesty + hideout hub: Closed by #153. Ballistics A leftover: Closed by #160. Range loft DNA + AIM TUNE stash: Closed by #161.
...
**Still local / other seat (deliberately):** powder A/B/C · Hypha STREAM · Augury · hub protect · `KIND_LOOT_WORLD` · Locus yard **80 m**. Range loft DNA + AIM TUNE stash **later landed #161**. Do **not** claim Hypha / Lab-Rat / Augury shipped this.

See `PEEK_FINDINGS.md` Closed by #160 + Closed by #161 + fulcrumRust `docs/BALLISTICS_A_DIAL_SHEET.md` + house `BALLISTICS_SPINE.md`.
...
**Still local / other seat (deliberately):** powder A/B/C · KIND_SHOT encode / leftover collide / HOST shared solve (Beabim #160) · Hypha STREAM / PeerBody mesh · Lab-Rat stamps · Augury chrome · #147 500 m / eye 1.60 / hub protect / `KIND_LOOT_WORLD` · no-pause / `fulcrum://`. Do **not** claim Beabim / Hypha / Lab-Rat / Augury shipped this Range half.

See `PEEK_FINDINGS.md` Closed by #161 + fulcrumRust `docs/BALLISTICS_A_DIAL_SHEET.md` + house `BALLISTICS_SPINE.md`.
...
**Still local / other seat (deliberately):** Hypha res / FOV / AA / AO / POST **later landed #164** · WARP / STREAM · Lab-Rat texture / mip / `lod_mips` · Augury remap / Tab inventory · PreferredHand A chrome **later landed #168** · AIM TUNE PX box · stamps · death chrome. Options default hip **Chest (default)** vs **Low** toggle + Powder B — Range still cooking; do **not** claim landed. AIM TUNE LIVE **#167** already landed (sibling). Do **not** invent implementation. Do **not** claim Hypha / Lab-Rat / Augury / Beabim shipped this.
...
**Still local / other seat (deliberately):** Lab-Rat texture / mipmap · Range mouse V/H + hip/ADS (**#163**) · Augury remaps + Tab · STREAM `StreamPolicy` · Powder / PreferredHand / ballistics / AIM TUNE · Beabim net · Bloom / godRays / brightness / gamma (**#86** no path). Do **not** add READY HIP rows. Do **not** claim Powder B. AIM TUNE LIVE **#167** is Range parallel. Do **not** claim Range / Lab-Rat / Augury / Beabim shipped this.
...
**Still local / other seat (deliberately):** Powder A/B/C · READY HIP persist rows (do **not** restamp) · AIM TUNE LIVE **#167** already landed (sibling persist) · Options mouse V/H + hip/ADS · Hypha 3P lean boxes · Lab-Rat stamps · Augury Home / glasses elbows / death chrome. Play U stays two poses (chosen hip ↔ canted) without adding READY HIP dials. Do **not** claim Hypha / Lab-Rat / Augury / Beabim shipped this.
...
Range Tech loft DNA + AIM TUNE leftover stash (consume Beabim #160; 1P `muzzle_and_launch` + `hip_honest_dir` + MOA is `KIND_SHOT.dir`; tracer streak steals `feel::step_ballistic` so local/peer follow the lofted `ShotEvent`; hitscan leftover stash does **not** flatten the streak; End **MODEL** writes `leftover_hit` (`hitscan` / `ballistic_A`); TELE/PERF `LEFTOVER` reads the same enum; no `NetShot.loft` / no 48-byte KIND / no `ballistic_model`; powder A/B/C parked; KIND_SHOT encode / leftover collide / HOST shared solve stay #160): fulcrumRust PR #161 (2026-09-10) — **landed**. Merge `4f47875376683f922c99adc7d7eb45a0736dc8a1`. See `PEEK_FINDINGS.md` Closed by #161 + fulcrumRust `docs/BALLISTICS_A_DIAL_SHEET.md` + house `BALLISTICS_SPINE.md`.
Range Tech Options mouse V/H + hip/ADS (Controls **MOUSE H** / **MOUSE V** / **HIP** / **ADS** on the existing #46 `LOOK_MUL` lock **1.00** / **0.25–2.00** / step **0.05**; persist `look_mul_h` / `look_mul_v` / `hip_look_mul` / `ads_look_mul`; old `look_mul` seeds both mouse axes when split keys are absent; feel-lab `look_sens` **0.0022** + feel ADS **0.86** / blend **6.4** stay DNA; Invert Y stays; Options READY HIP **#165** already landed (sibling). Powder B still cooking — do **not** claim landed; Hypha res/FOV/AA/AO/post/WARP/STREAM · Lab-Rat texture/mip · Augury remap/Tab · PreferredHand · AIM TUNE PX left alone): fulcrumRust PR #163 (2026-09-10) — **landed**. Merge `96e4410e`. See `PEEK_FINDINGS.md` Closed by #163 + house `OPTIONS_SHELF.md` + fulcrumRust `docs/OPTIONS_MOUSE_SENS_DIAL_SHEET.md`.
...
Hypha Options Graphics shelf (RES default **NATIVE** + Evan **3440×1440** + Steam survey **2560×1600 / 1920×1200 / 1366×768** · FOV hip base **90** · AA **FXAA/OFF** · AA STR live #55 mix **0.5** · AO **OFF/LOW/HIGH** Low 8-tap · r **0.55** / High **24**-tap same radius · POST **OFF/LOW/HIGH** default HIGH; persist `resolution` / `fov_hip` / `aa_type` / `aa_strength` / `ao_quality` / `post_quality`; old `ao`/`aa` bools still load; pane FOV 70–110 / step 1 is chrome — **not** tip-locked; WINDOW / CA / GRAIN / DOF / FOG / CAM / WARP / STREAM unchanged; Lab-Rat texture/mip · Range #163 · Augury remap/Tab · STREAM policy · Powder left alone; AIM TUNE LIVE **#167** already landed): fulcrumRust PR #164 (2026-09-10) — **landed**. Merge `159b3d11`. See `PEEK_FINDINGS.md` Closed by #164 + house `OPTIONS_SHELF.md` + fulcrumRust `docs/OPTIONS_GRAPHICS_DIAL_SHEET.md`.
Range Tech PreferredHand A hold-bone mirror + HAND L/R chrome (**`HAND R` / `HAND L`** from live hold X — gun right of camera middle = HAND R, not inverted `Shoulder` enum; one right bank + sagittal **−X / −yaw / −roll** cant **0.785** → **−0.785**; pitch/Y/Z stay; **no** `scale.x = −1`; H is live HAND flip; #116 onboard seats home; AIM TUNE shows **HAND · kit · pose**; WEAPON +X while HAND L writes authored −X; crosshair hides `ads_factor` **> 0.5**; hip + U-cycle canted keep it; End PX **±0.50** held; leftover H dest ~**−0.041** not the live left hold; do **not** claim Powder B; READY HIP **#165** already landed (sibling); AIM TUNE LIVE **#167** already landed): fulcrumRust PR #168 (2026-09-10) — **landed**. Merge `1849ce6b`. See `PEEK_FINDINGS.md` Closed by #168 + house `HOLD_POSE_SPINE.md` + fulcrumRust `docs/PREFERRED_HAND_A_DIAL_SHEET.md`.
...
Range Tech Options READY HIP + two-pose play (Gameplay **CHEST** tip default / **LOW HIP**; persist `default_hip` `chest` / `low`; aliases `chest`/`ready`/`hip` · `low`/`low_hip`/`hip_low`; missing = Chest; authored `hip` Y **−0.2128** / `hip_low` Y **−0.3528**; in-play **U** is chosen hip ↔ canted only; spawn/ready seats the pick; Hold-Mouse5 still `ads_cant`; shotgun `default_hip_override` hook only — day-one kits `None`; Controls mouse V/H + hip/ADS stay planted **#163** — do not restamp; PreferredHand chrome not invented; Powder B still cooking; AIM TUNE LIVE **#167** already landed): fulcrumRust PR #165 (2026-09-10) — **landed**. Merge `9b8121b1`. See `PEEK_FINDINGS.md` Closed by #165 + house `OPTIONS_SHELF.md` + fulcrumRust `docs/OPTIONS_DEFAULT_HIP_DIAL_SHEET.md`.
